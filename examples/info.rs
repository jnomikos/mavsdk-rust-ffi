/*fn main() {
    ...
    let mut mavsdk_instance = base::mavsdk::Mavsdk::new1(&config).within_unique_ptr();

    cxx::let_cxx_string!(conn_str = "serial:///dev/ttyACM0:115200");
    let mavsdk_connection_result = mavsdk_instance.pin_mut().add_any_connection(&conn_str, base::mavsdk::ForwardingOption::ForwardingOff);
    ...
    unsafe {
        base::mavsdk_wait_on_new_system(
    ...
    unsafe {
        let system_ptr = base::mavsdk_system_get(mavsdk_instance.as_mut_ptr(), system_index);
