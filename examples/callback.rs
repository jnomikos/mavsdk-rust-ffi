...
fn system_callback(value: core::mavsdk::System) {
...
fn main() {
    ...
    cxx::let_cxx_string!(conn_str = "serial:///dev/ttyACM1:115200");
    ...
    unsafe {
        let system_handle = core::subscribe_on_new_system(mavsdk_instance.as_mut_ptr(), sys_cb_ptr as libc::uintptr_t);

        // Await until we get system
        std::thread::sleep(std::time::Duration::from_secs(10));
        core::unsubscribe_on_new_system(mavsdk_instance.as_mut_ptr(),system_handle);
    }
}