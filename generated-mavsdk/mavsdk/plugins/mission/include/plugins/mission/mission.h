...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/mission/mission.proto)
...
public:
  ...
  struct MissionItem { /**
    ...
    enum class CameraAction {
      ...
      StartPhotoInterval, /**< @brief Start capturing photos at regular
                             intervals. */
      ...
      StartPhotoDistance, /**< @brief Start capturing photos at regular
                             distance. */
     ...
     * `Mission::CameraAction`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream &operator<<(
        std::ostream &str,
        Mission::MissionItem::CameraAction const &
            camera_action); /**
    ...
    enum class VehicleAction {
      ...
      Land, /**< @brief When a waypoint is reached vehicle will land at current
               position. */
      TransitionToFw, /**< @brief When a waypoint is reached vehicle will
                         transition to fixed-wing mode. */
      TransitionToMc, /**< @brief When a waypoint is reached vehicle will
                         transition to multi-copter mode. */
    };

    /**
     * @brief Stream operator to print information about a
     * `Mission::VehicleAction`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream &
   ...
   */
  friend bool operator==(const Mission::MissionItem &lhs,
                         const Mission::MissionItem &rhs);
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Mission::MissionItem const &mission_item);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Mission::MissionPlan &lhs,
                         const Mission::MissionPlan &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Mission::MissionPlan const &mission_plan);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Mission::MissionProgress &lhs,
                         const Mission::MissionProgress &rhs);
  ...
  friend std::ostream &
  operator<<(std::ostream &str,
             Mission::MissionProgress const &mission_progress);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Mission::ProgressData &lhs,
                         const Mission::ProgressData &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Mission::ProgressData const &progress_data);

  /**
   * @brief Progress data coming from mission download, or the mission itself
  ...
  /**
   * @brief Equal operator to compare two `Mission::ProgressDataOrMission`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const Mission::ProgressDataOrMission &lhs,
                         const Mission::ProgressDataOrMission &rhs);
  ...
  friend std::ostream &
  operator<<(std::ostream &str,
             Mission::ProgressDataOrMission const &progress_data_or_mission);
   ...
   * counterpart.
   */
  void upload_mission_async(MissionPlan mission_plan,
   ...
   */
  using UploadMissionWithProgressCallback =
      std::function<void(Result, ProgressData)>;
   ...
   * beginning. If it is set to a specific index of a mission item, the mission
   * will be set to this item.
   *
   * Note that this is not necessarily true for general missions using MAVLink
   * if loop counters are used.
   *
   ...
   * to a specific index of a mission item, the mission will be set to this
   item.
   *
   * Note that this is not necessarily true for general missions using MAVLink
   if loop counters
  ...
  /**
   * @brief Get whether to trigger Return-to-Launch (RTL) after mission is
   * complete.
   *
  ...
  /**
   * @brief Set whether to trigger Return-to-Launch (RTL) after the mission is
   complete.
   *
