...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/param_server/param_server.proto)
...
public:
   ...
   */
  friend bool operator==(const ParamServer::IntParam &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const ParamServer::FloatParam &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const ParamServer::CustomParam &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const ParamServer::AllParams &lhs,
  ...
  enum class Result {
    ...
    ParamProvidedTooLate, /**< @brief All parameters have to be provided
                             upfront. */
  };
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  ParamServer::Result const &result);
   ...
   *
   * The extended param protocol is used by default. This allows to use the
   previous/normal one.
   *
   * Note that camera definition files are meant to implement/use the extended
   protocol.
   *
   ...
   */
  void unsubscribe_changed_param_int(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_changed_param_float(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_changed_param_custom(uintptr_t handle_ptr);
