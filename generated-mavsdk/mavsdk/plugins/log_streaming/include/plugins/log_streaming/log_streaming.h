...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/log_streaming/log_streaming.proto)
...
public:
  ...
  /**
   * @brief Equal operator to compare two `LogStreaming::LogStreamingRaw`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const LogStreaming::LogStreamingRaw &lhs,
                         const LogStreaming::LogStreamingRaw &rhs);
  ...
  operator<<(std::ostream &str,
             LogStreaming::LogStreamingRaw const &log_streaming_raw);
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  LogStreaming::Result const &result);
   ...
   *
   * This function is non-blocking. See 'start_log_streaming' for the blocking
   * counterpart.
   */
   ...
   * @brief Start streaming logging data.
   *
   * This function is blocking. See 'start_log_streaming_async' for the
   ...
   *
   * This function is non-blocking. See 'stop_log_streaming' for the blocking
   * counterpart.
   */
   ...
   * @brief Stop streaming logging data.
   *
   * This function is blocking. See 'stop_log_streaming_async' for the
   non-blocking counterpart.
   *
   ...
   */
  void unsubscribe_log_streaming_raw(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to logging messages
   */
  LogStreamingRawHandle
  subscribe_log_streaming_raw(const LogStreamingRawCallback &callback);
