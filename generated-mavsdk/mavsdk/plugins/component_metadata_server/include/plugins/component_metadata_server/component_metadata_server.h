...
public:
   ...
   *
   *     ```cpp
   *     auto component_metadata_server =
   * ComponentMetadataServer(server_component);
   *     ```
   *
   * @param server_component The ServerComponent instance associated with this
   * server plugin.
   */
  explicit ComponentMetadataServer(
   ...
   * `ComponentMetadataServer::MetadataType`.
   *
   * @return A reference to the stream.
   */
  friend std::ostream &
  operator<<(std::ostream &str,
             ComponentMetadataServer::MetadataType const &metadata_type);
  ...
  /**
   * @brief Equal operator to compare two `ComponentMetadataServer::Metadata`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const ComponentMetadataServer::Metadata &lhs,
                         const ComponentMetadataServer::Metadata &rhs);
  ...
  friend std::ostream &
  operator<<(std::ostream &str,
             ComponentMetadataServer::Metadata const &metadata);
  ...
  operator=(const ComponentMetadataServer &) = delete;
