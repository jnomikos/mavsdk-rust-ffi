...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/action_server/action_server.proto)
...
/**
 * @brief Provide vehicle actions (as a server) such as arming, taking off, and
 * landing.
 */
...
public:
  ...
  /**
   * @brief Equal operator to compare two `ActionServer::AllowableFlightModes`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const ActionServer::AllowableFlightModes &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const ActionServer::ArmDisarm &lhs,
   ...
   */
  void unsubscribe_arm_disarm(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_flight_mode_change(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_takeoff(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_land(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_reboot(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_shutdown(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_terminate(uintptr_t handle_ptr);
  ...
  /**
   * @brief Set which modes the vehicle can transition to (Manual always
   allowed)
   *
   * This function is blocking.
   *
  ...
  /**
   * @brief Get which modes the vehicle can transition to (Manual always
   * allowed)
   *
   * This function is blocking.
   *
  ...
  /**
   * @brief Set/override the armed/disarmed state of the vehicle directly, and
   notify subscribers
   *
   * This function is blocking.
   *
  ...
  /**
   * @brief Set/override the flight mode of the vehicle directly, and notify
   subscribers
   *
   * This function is blocking.
   *
