...
CameraServer::Result
CameraServer::set_information(Information information) const {
  return _impl->set_information(information);
}

CameraServer::Result
CameraServer::set_video_streaming(VideoStreaming video_streaming) const {
...
void CameraServer::unsubscribe_take_photo(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<TakePhotoHandle *>(handle_ptr);
  _impl->unsubscribe_take_photo(*handle);
  delete handle;
}

CameraServer::TakePhotoHandle
CameraServer::subscribe_take_photo(const TakePhotoCallback &callback) {
...
CameraServer::Result
CameraServer::respond_take_photo(CameraFeedback take_photo_feedback,
...
void CameraServer::unsubscribe_start_video(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<StartVideoHandle *>(handle_ptr);
...
CameraServer::Result
CameraServer::respond_start_video(CameraFeedback start_video_feedback) const {
...
void CameraServer::unsubscribe_stop_video(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<StopVideoHandle *>(handle_ptr);
  _impl->unsubscribe_stop_video(*handle);
  delete handle;
}

CameraServer::StopVideoHandle
CameraServer::subscribe_stop_video(const StopVideoCallback &callback) {
...
CameraServer::Result
CameraServer::respond_stop_video(CameraFeedback stop_video_feedback) const {
...
void CameraServer::unsubscribe_start_video_streaming(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<StartVideoStreamingHandle *>(handle_ptr);
  _impl->unsubscribe_start_video_streaming(*handle);
  delete handle;
}

CameraServer::StartVideoStreamingHandle
CameraServer::subscribe_start_video_streaming(
    const StartVideoStreamingCallback &callback) {
  return _impl->subscribe_start_video_streaming(callback);
}

void CameraServer::unsubscribe_start_video_streaming(
    StartVideoStreamingHandle handle) {
  _impl->unsubscribe_start_video_streaming(handle);
}

CameraServer::Result CameraServer::respond_start_video_streaming(
    CameraFeedback start_video_streaming_feedback) const {
...
void CameraServer::unsubscribe_stop_video_streaming(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<StopVideoStreamingHandle *>(handle_ptr);
...
void CameraServer::unsubscribe_stop_video_streaming(
    StopVideoStreamingHandle handle) {
  _impl->unsubscribe_stop_video_streaming(handle);
}

CameraServer::Result CameraServer::respond_stop_video_streaming(
    CameraFeedback stop_video_streaming_feedback) const {
...
void CameraServer::unsubscribe_set_mode(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<SetModeHandle *>(handle_ptr);
  _impl->unsubscribe_set_mode(*handle);
  delete handle;
}

CameraServer::SetModeHandle
CameraServer::subscribe_set_mode(const SetModeCallback &callback) {
...
CameraServer::Result
CameraServer::respond_set_mode(CameraFeedback set_mode_feedback) const {
...
void CameraServer::unsubscribe_storage_information(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<StorageInformationHandle *>(handle_ptr);
  _impl->unsubscribe_storage_information(*handle);
  delete handle;
}

CameraServer::StorageInformationHandle
CameraServer::subscribe_storage_information(
    const StorageInformationCallback &callback) {
  return _impl->subscribe_storage_information(callback);
}

void CameraServer::unsubscribe_storage_information(
...
CameraServer::Result CameraServer::respond_storage_information(
  ...
  return _impl->respond_storage_information(storage_information_feedback,
                                            storage_information);
}
...
void CameraServer::unsubscribe_capture_status(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<CaptureStatusHandle *>(handle_ptr);
...
CameraServer::Result
CameraServer::respond_capture_status(CameraFeedback capture_status_feedback,
                                     CaptureStatus capture_status) const {
...
void CameraServer::unsubscribe_format_storage(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<FormatStorageHandle *>(handle_ptr);
...
CameraServer::Result CameraServer::respond_format_storage(
    CameraFeedback format_storage_feedback) const {
...
void CameraServer::unsubscribe_reset_settings(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ResetSettingsHandle *>(handle_ptr);
...
CameraServer::Result CameraServer::respond_reset_settings(
    CameraFeedback reset_settings_feedback) const {
...
void CameraServer::unsubscribe_zoom_in_start(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ZoomInStartHandle *>(handle_ptr);
...
CameraServer::Result CameraServer::respond_zoom_in_start(
    CameraFeedback zoom_in_start_feedback) const {
...
void CameraServer::unsubscribe_zoom_out_start(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ZoomOutStartHandle *>(handle_ptr);
...
CameraServer::Result CameraServer::respond_zoom_out_start(
    CameraFeedback zoom_out_start_feedback) const {
...
void CameraServer::unsubscribe_zoom_stop(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ZoomStopHandle *>(handle_ptr);
  _impl->unsubscribe_zoom_stop(*handle);
  delete handle;
}

CameraServer::ZoomStopHandle
CameraServer::subscribe_zoom_stop(const ZoomStopCallback &callback) {
...
CameraServer::Result
CameraServer::respond_zoom_stop(CameraFeedback zoom_stop_feedback) const {
...
void CameraServer::unsubscribe_zoom_range(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ZoomRangeHandle *>(handle_ptr);
  _impl->unsubscribe_zoom_range(*handle);
  delete handle;
}

CameraServer::ZoomRangeHandle
CameraServer::subscribe_zoom_range(const ZoomRangeCallback &callback) {
...
CameraServer::Result
CameraServer::respond_zoom_range(CameraFeedback zoom_range_feedback) const {
  return _impl->respond_zoom_range(zoom_range_feedback);
}

void CameraServer::set_tracking_rectangle_status(
    TrackRectangle tracked_rectangle) const {
...
void CameraServer::unsubscribe_tracking_point_command(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<TrackingPointCommandHandle *>(handle_ptr);
  _impl->unsubscribe_tracking_point_command(*handle);
  delete handle;
}

CameraServer::TrackingPointCommandHandle
CameraServer::subscribe_tracking_point_command(
    const TrackingPointCommandCallback &callback) {
  return _impl->subscribe_tracking_point_command(callback);
}

void CameraServer::unsubscribe_tracking_point_command(
...
void CameraServer::unsubscribe_tracking_rectangle_command(
    uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<TrackingRectangleCommandHandle *>(handle_ptr);
  _impl->unsubscribe_tracking_rectangle_command(*handle);
  delete handle;
}

CameraServer::TrackingRectangleCommandHandle
CameraServer::subscribe_tracking_rectangle_command(
...
void CameraServer::unsubscribe_tracking_off_command(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<TrackingOffCommandHandle *>(handle_ptr);
  _impl->unsubscribe_tracking_off_command(*handle);
  delete handle;
}

CameraServer::TrackingOffCommandHandle
CameraServer::subscribe_tracking_off_command(
    const TrackingOffCommandCallback &callback) {
  return _impl->subscribe_tracking_off_command(callback);
}

void CameraServer::unsubscribe_tracking_off_command(
    TrackingOffCommandHandle handle) {
  _impl->unsubscribe_tracking_off_command(handle);
}

CameraServer::Result CameraServer::respond_tracking_point_command(
    CameraFeedback stop_video_feedback) const {
  return _impl->respond_tracking_point_command(stop_video_feedback);
}

CameraServer::Result CameraServer::respond_tracking_rectangle_command(
    CameraFeedback stop_video_feedback) const {
  return _impl->respond_tracking_rectangle_command(stop_video_feedback);
}

CameraServer::Result CameraServer::respond_tracking_off_command(
    CameraFeedback stop_video_feedback) const {
  return _impl->respond_tracking_off_command(stop_video_feedback);
}

bool operator==(const CameraServer::Information &lhs,
                const CameraServer::Information &rhs) {
  return (rhs.vendor_name == lhs.vendor_name) &&
         (rhs.model_name == lhs.model_name) &&
         (rhs.firmware_version == lhs.firmware_version) &&
         ((std::isnan(rhs.focal_length_mm) &&
           std::isnan(lhs.focal_length_mm)) ||
         ...
         ((std::isnan(rhs.vertical_sensor_size_mm) &&
           std::isnan(lhs.vertical_sensor_size_mm)) ||
         ...
         (rhs.image_in_video_mode_supported ==
          lhs.image_in_video_mode_supported) &&
         (rhs.video_in_image_mode_supported ==
          lhs.video_in_image_mode_supported);
}

std::ostream &operator<<(std::ostream &str,
                         CameraServer::Information const &information) {
  ...
  str << "    horizontal_sensor_size_mm: "
      << information.horizontal_sensor_size_mm << '\n';
  str << "    vertical_sensor_size_mm: " << information.vertical_sensor_size_mm
      << '\n';
  str << "    horizontal_resolution_px: "
      << information.horizontal_resolution_px << '\n';
  ...
  str << "    image_in_video_mode_supported: "
      << information.image_in_video_mode_supported << '\n';
  str << "    video_in_image_mode_supported: "
      << information.video_in_image_mode_supported << '\n';
  str << '}';
  return str;
}

bool operator==(const CameraServer::VideoStreaming &lhs,
                const CameraServer::VideoStreaming &rhs) {
  return (rhs.has_rtsp_server == lhs.has_rtsp_server) &&
         (rhs.rtsp_uri == lhs.rtsp_uri);
}

std::ostream &operator<<(std::ostream &str,
                         CameraServer::VideoStreaming const &video_streaming) {
  str << std::setprecision(15);
  str << "video_streaming:" << '\n' << "{\n";
...
bool operator==(const CameraServer::Position &lhs,
                const CameraServer::Position &rhs) {
...
std::ostream &operator<<(std::ostream &str,
                         CameraServer::Position const &position) {
  str << std::setprecision(15);
  str << "position:" << '\n' << "{\n";
...
bool operator==(const CameraServer::Quaternion &lhs,
                const CameraServer::Quaternion &rhs) {
...
std::ostream &operator<<(std::ostream &str,
                         CameraServer::Quaternion const &quaternion) {
  str << std::setprecision(15);
  str << "quaternion:" << '\n' << "{\n";
  str << "    w: " << quaternion.w << '\n';
  str << "    x: " << quaternion.x << '\n';
...
bool operator==(const CameraServer::CaptureInfo &lhs,
                const CameraServer::CaptureInfo &rhs) {
  return (rhs.position == lhs.position) &&
         (rhs.attitude_quaternion == lhs.attitude_quaternion) &&
         (rhs.time_utc_us == lhs.time_utc_us) &&
         (rhs.is_success == lhs.is_success) && (rhs.index == lhs.index) &&
         (rhs.file_url == lhs.file_url);
}

std::ostream &operator<<(std::ostream &str,
                         CameraServer::CaptureInfo const &capture_info) {
  str << std::setprecision(15);
  str << "capture_info:" << '\n' << "{\n";
...
std::ostream &operator<<(std::ostream &str,
                         CameraServer::Result const &result) {
  switch (result) {
...
bool operator==(const CameraServer::StorageInformation &lhs,
                const CameraServer::StorageInformation &rhs) {
  return ((std::isnan(rhs.used_storage_mib) &&
           std::isnan(lhs.used_storage_mib)) ||
          rhs.used_storage_mib == lhs.used_storage_mib) &&
         ((std::isnan(rhs.available_storage_mib) &&
           std::isnan(lhs.available_storage_mib)) ||
          rhs.available_storage_mib == lhs.available_storage_mib) &&
         ((std::isnan(rhs.total_storage_mib) &&
           std::isnan(lhs.total_storage_mib)) ||
         ...
         ((std::isnan(rhs.read_speed_mib_s) &&
           std::isnan(lhs.read_speed_mib_s)) ||
          rhs.read_speed_mib_s == lhs.read_speed_mib_s) &&
         ((std::isnan(rhs.write_speed_mib_s) &&
           std::isnan(lhs.write_speed_mib_s)) ||
          rhs.write_speed_mib_s == lhs.write_speed_mib_s);
}

std::ostream &
operator<<(std::ostream &str,
           CameraServer::StorageInformation const &storage_information) {
  str << std::setprecision(15);
  str << "storage_information:" << '\n' << "{\n";
  str << "    used_storage_mib: " << storage_information.used_storage_mib
      << '\n';
  str << "    available_storage_mib: "
...
std::ostream &
operator<<(std::ostream &str,
           CameraServer::CaptureStatus::ImageStatus const &image_status) {
  switch (image_status) {
...
bool operator==(const CameraServer::CaptureStatus &lhs,
                const CameraServer::CaptureStatus &rhs) {
  return ((std::isnan(rhs.image_interval_s) &&
           std::isnan(lhs.image_interval_s)) ||
          rhs.image_interval_s == lhs.image_interval_s) &&
         ((std::isnan(rhs.recording_time_s) &&
           std::isnan(lhs.recording_time_s)) ||
          rhs.recording_time_s == lhs.recording_time_s) &&
         ((std::isnan(rhs.available_capacity_mib) &&
           std::isnan(lhs.available_capacity_mib)) ||
...
std::ostream &operator<<(std::ostream &str,
                         CameraServer::CaptureStatus const &capture_status) {
  str << std::setprecision(15);
  str << "capture_status:" << '\n' << "{\n";
...
bool operator==(const CameraServer::TrackPoint &lhs,
                const CameraServer::TrackPoint &rhs) {
  return ((std::isnan(rhs.point_x) && std::isnan(lhs.point_x)) ||
          rhs.point_x == lhs.point_x) &&
         ((std::isnan(rhs.point_y) && std::isnan(lhs.point_y)) ||
          rhs.point_y == lhs.point_y) &&
         ((std::isnan(rhs.radius) && std::isnan(lhs.radius)) ||
          rhs.radius == lhs.radius);
}

std::ostream &operator<<(std::ostream &str,
                         CameraServer::TrackPoint const &track_point) {
  str << std::setprecision(15);
  str << "track_point:" << '\n' << "{\n";
...
bool operator==(const CameraServer::TrackRectangle &lhs,
                const CameraServer::TrackRectangle &rhs) {
  return ((std::isnan(rhs.top_left_corner_x) &&
           std::isnan(lhs.top_left_corner_x)) ||
          rhs.top_left_corner_x == lhs.top_left_corner_x) &&
         ((std::isnan(rhs.top_left_corner_y) &&
           std::isnan(lhs.top_left_corner_y)) ||
          rhs.top_left_corner_y == lhs.top_left_corner_y) &&
         ((std::isnan(rhs.bottom_right_corner_x) &&
           std::isnan(lhs.bottom_right_corner_x)) ||
          rhs.bottom_right_corner_x == lhs.bottom_right_corner_x) &&
         ((std::isnan(rhs.bottom_right_corner_y) &&
           std::isnan(lhs.bottom_right_corner_y)) ||
          rhs.bottom_right_corner_y == lhs.bottom_right_corner_y);
}

std::ostream &operator<<(std::ostream &str,
                         CameraServer::TrackRectangle const &track_rectangle) {
  str << std::setprecision(15);
  str << "track_rectangle:" << '\n' << "{\n";
...
std::ostream &operator<<(std::ostream &str,
                         CameraServer::CameraFeedback const &camera_feedback) {
