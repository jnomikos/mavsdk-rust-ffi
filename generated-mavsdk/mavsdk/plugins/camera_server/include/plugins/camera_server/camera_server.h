...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/camera_server/camera_server.proto)
...
public:
   ...
   */
  friend bool operator==(const CameraServer::Information &lhs,
  ...
  /**
   * @brief Equal operator to compare two `CameraServer::VideoStreaming`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::VideoStreaming &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::Position &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::Quaternion &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::CaptureInfo &lhs,
  ...
  struct StorageInformation { /**
    ...
    /**
     * @brief Stream operator to print information about a
     * `CameraServer::StorageStatus`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream &
    operator<<(std::ostream &str,
               CameraServer::StorageInformation::StorageStatus const
                   &storage_status); /**
                                      * @brief Storage type.
                                      */
  ...
  /**
   * @brief Equal operator to compare two `CameraServer::StorageInformation`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::StorageInformation &lhs,
  ...
  struct CaptureStatus { /**
    ...
    /**
     * @brief Stream operator to print information about a
     * `CameraServer::ImageStatus`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream &
    operator<<(std::ostream &str, CameraServer::CaptureStatus::ImageStatus const
                                      &image_status); /**
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::CaptureStatus &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::TrackPoint &lhs,
  ...
  /**
   * @brief Equal operator to compare two `CameraServer::TrackRectangle`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const CameraServer::TrackRectangle &lhs,
  ...
  /**
   * @brief Sets the camera information. This must be called as soon as the
   camera server is created.
   *
  ...
  /**
   * @brief Sets image capture in progress status flags. This should be set to
   true when the camera is busy taking a photo and false when it is done.
   *
   * This function is blocking.
   *
   ...
   */
  void unsubscribe_take_photo(uintptr_t handle_ptr);
   ...
   */
  Result respond_take_photo(CameraFeedback take_photo_feedback,
   ...
   */
  void unsubscribe_start_video(uintptr_t handle_ptr);
   ...
   * @brief Subscribe to stop video requests. Each request received should
   respond using StopVideoResponse
   *
   * This function is blocking.
   *
   ...
   */
  void unsubscribe_stop_video(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_start_video_streaming(uintptr_t handle_ptr);
   ...
   */
  Result respond_start_video_streaming(
   ...
   */
  void unsubscribe_stop_video_streaming(uintptr_t handle_ptr);
   ...
   */
  Result respond_stop_video_streaming(
   ...
   */
  void unsubscribe_set_mode(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_storage_information(uintptr_t handle_ptr);
  ...
  /**
   * @brief Respond to camera storage information from
   ...
   */
  Result
  respond_storage_information(CameraFeedback storage_information_feedback,
   ...
   */
  void unsubscribe_capture_status(uintptr_t handle_ptr);
   ...
   */
  Result respond_capture_status(CameraFeedback capture_status_feedback,
   ...
   */
  void unsubscribe_format_storage(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_reset_settings(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_zoom_in_start(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to zoom in start command
   */
  ZoomInStartHandle
  subscribe_zoom_in_start(const ZoomInStartCallback &callback);
   ...
   */
  void unsubscribe_zoom_out_start(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to zoom out start command
   */
  ZoomOutStartHandle
  subscribe_zoom_out_start(const ZoomOutStartCallback &callback);
   ...
   */
  void unsubscribe_zoom_stop(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_zoom_range(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_tracking_point_command(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to incoming tracking point command.
   */
  TrackingPointCommandHandle subscribe_tracking_point_command(
   ...
   */
  void unsubscribe_tracking_rectangle_command(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to incoming tracking rectangle command.
   */
  TrackingRectangleCommandHandle subscribe_tracking_rectangle_command(
   ...
   */
  void unsubscribe_tracking_off_command(uintptr_t handle_ptr);
   ...
   */
  Result
  respond_tracking_point_command(CameraFeedback stop_video_feedback) const;
   ...
   */
  Result
  respond_tracking_rectangle_command(CameraFeedback stop_video_feedback) const;
