...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/offboard/offboard.proto)
...
Offboard::Offboard(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<OffboardImpl>(system)} {}
...
Offboard::Result Offboard::start() const { return _impl->start(); }

void Offboard::stop_async(const ResultCallback callback) {
  _impl->stop_async(callback);
}

Offboard::Result Offboard::stop() const { return _impl->stop(); }

bool Offboard::is_active() const { return _impl->is_active(); }
...
Offboard::Result
Offboard::set_actuator_control(ActuatorControl actuator_control) const {
...
Offboard::Result
Offboard::set_position_ned(PositionNedYaw position_ned_yaw) const {
  return _impl->set_position_ned(position_ned_yaw);
}

Offboard::Result
Offboard::set_position_global(PositionGlobalYaw position_global_yaw) const {
  return _impl->set_position_global(position_global_yaw);
}

Offboard::Result
Offboard::set_velocity_body(VelocityBodyYawspeed velocity_body_yawspeed) const {
  return _impl->set_velocity_body(velocity_body_yawspeed);
}

Offboard::Result
Offboard::set_velocity_ned(VelocityNedYaw velocity_ned_yaw) const {
  return _impl->set_velocity_ned(velocity_ned_yaw);
}

Offboard::Result
Offboard::set_position_velocity_ned(PositionNedYaw position_ned_yaw,
...
Offboard::Result
Offboard::set_acceleration_ned(AccelerationNed acceleration_ned) const {
...
bool operator==(const Offboard::ActuatorControlGroup &lhs,
...
operator<<(std::ostream &str,
  ...
  for (auto it = actuator_control_group.controls.begin();
       it != actuator_control_group.controls.end(); ++it) {
    str << *it;
...
bool operator==(const Offboard::ActuatorControl &lhs,
...
std::ostream &operator<<(std::ostream &str,
  ...
  str << "    groups: [";
  for (auto it = actuator_control.groups.begin();
       it != actuator_control.groups.end(); ++it) {
    str << *it;
...
bool operator==(const Offboard::AttitudeRate &lhs,
...
bool operator==(const Offboard::PositionNedYaw &lhs,
...
bool operator==(const Offboard::PositionGlobalYaw &lhs,
                const Offboard::PositionGlobalYaw &rhs) {
  return ((std::isnan(rhs.lat_deg) && std::isnan(lhs.lat_deg)) ||
          rhs.lat_deg == lhs.lat_deg) &&
         ((std::isnan(rhs.lon_deg) && std::isnan(lhs.lon_deg)) ||
          rhs.lon_deg == lhs.lon_deg) &&
         ((std::isnan(rhs.alt_m) && std::isnan(lhs.alt_m)) ||
          rhs.alt_m == lhs.alt_m) &&
         ((std::isnan(rhs.yaw_deg) && std::isnan(lhs.yaw_deg)) ||
          rhs.yaw_deg == lhs.yaw_deg) &&
...
bool operator==(const Offboard::VelocityNedYaw &lhs,
...
bool operator==(const Offboard::AccelerationNed &lhs,
