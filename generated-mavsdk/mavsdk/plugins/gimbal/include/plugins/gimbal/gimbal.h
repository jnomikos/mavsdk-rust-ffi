...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/gimbal/gimbal.proto)
...
public:
  ...
  enum class GimbalMode {
    YawFollow, /**< @brief Yaw follow will point the gimbal to the vehicle
                  heading. */
    YawLock,   /**< @brief Yaw lock will fix the gimbal pointing to an absolute
                  direction. */
  };
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::GimbalMode const &gimbal_mode);

  /**
   * @brief Control mode
   */
  enum class ControlMode {
    None,    /**< @brief Indicates that the component does not have control over
                the gimbal. */
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::ControlMode const &control_mode);

  /**
   * @brief The send mode type
   */
  enum class SendMode {
    Once, /**< @brief Send command exactly once with quality of service (use for
             sporadic commands slower than 1 Hz). */
    Stream, /**< @brief Stream setpoint without quality of service (use for
               setpoints faster than 1 Hz).. */
  };
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::SendMode const &send_mode);
   ...
   */
  friend bool operator==(const Gimbal::Quaternion &lhs,
                         const Gimbal::Quaternion &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::Quaternion const &quaternion);

  /**
   * @brief Euler angle type.
   *
   * All rotations and axis systems follow the right-hand rule.
   * The Euler angles are converted using the 3-1-2 sequence instead of standard
   * 3-2-1 in order to avoid the gimbal lock at 90 degrees down.
   *
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Gimbal::EulerAngle &lhs,
                         const Gimbal::EulerAngle &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::EulerAngle const &euler_angle);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Gimbal::AngularVelocityBody &lhs,
                         const Gimbal::AngularVelocityBody &rhs);
  ...
  operator<<(std::ostream &str,
             Gimbal::AngularVelocityBody const &angular_velocity_body);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Gimbal::Attitude &lhs,
                         const Gimbal::Attitude &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::Attitude const &attitude);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Gimbal::GimbalItem &lhs,
                         const Gimbal::GimbalItem &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::GimbalItem const &gimbal_item);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Gimbal::GimbalList &lhs,
                         const Gimbal::GimbalList &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::GimbalList const &gimbal_list);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Gimbal::ControlStatus &lhs,
                         const Gimbal::ControlStatus &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Gimbal::ControlStatus const &control_status);
   ...
   *
   * This function is non-blocking. See 'set_angles' for the blocking
   * counterpart.
   */
  void set_angles_async(int32_t gimbal_id, float roll_deg, float pitch_deg,
                        float yaw_deg, GimbalMode gimbal_mode,
                        SendMode send_mode, const ResultCallback callback);
   ...
   * Note that the roll angle needs to be set to 0 when send_mode is Once.
   *
   * This function is blocking. See 'set_angles_async' for the non-blocking
   counterpart.
   *
   ...
   */
  Result set_angles(int32_t gimbal_id, float roll_deg, float pitch_deg,
                    float yaw_deg, GimbalMode gimbal_mode,
   ...
   *
   * This sets the desired angular rates around roll, pitch and yaw axes of a
   * gimbal. Will return when the command is accepted, however, it might take
   * the gimbal longer to actually reach the angular rate.
   *
   * Note that the roll angle needs to be set to 0 when send_mode is Once.
   *
   * This function is non-blocking. See 'set_angular_rates' for the blocking
   * counterpart.
   */
  void set_angular_rates_async(int32_t gimbal_id, float roll_rate_deg_s,
                               float pitch_rate_deg_s, float yaw_rate_deg_s,
                               GimbalMode gimbal_mode, SendMode send_mode,
   ...
   * Note that the roll angle needs to be set to 0 when send_mode is Once.
   *
   * This function is blocking. See 'set_angular_rates_async' for the
   ...
   */
  Result set_angular_rates(int32_t gimbal_id, float roll_rate_deg_s,
                           float pitch_rate_deg_s, float yaw_rate_deg_s,
                           GimbalMode gimbal_mode, SendMode send_mode) const;
   ...
   *
   * This function is non-blocking. See 'set_roi_location' for the blocking
   * counterpart.
   */
  void set_roi_location_async(int32_t gimbal_id, double latitude_deg,
   ...
   * take the gimbal longer to actually rotate to the ROI.
   *
   * This function is blocking. See 'set_roi_location_async' for the
   non-blocking counterpart.
   *
   ...
   */
  Result set_roi_location(int32_t gimbal_id, double latitude_deg,
                          double longitude_deg, float altitude_m) const;
   ...
   *
   * This function is non-blocking. See 'take_control' for the blocking
   * counterpart.
   */
  void take_control_async(int32_t gimbal_id, ControlMode control_mode,
                          const ResultCallback callback);
   ...
   * override each other and should therefore do it carefully.
   *
   * This function is blocking. See 'take_control_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'release_control' for the blocking
   * counterpart.
   */
   ...
   * Release control, such that other components can control the gimbal.
   *
   * This function is blocking. See 'release_control_async' for the non-blocking
   counterpart.
   *
   ...
   */
  void unsubscribe_gimbal_list(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_control_status(uintptr_t handle_ptr);
   ...
   */
  ControlStatusHandle
  subscribe_control_status(const ControlStatusCallback &callback);
   ...
   * @return Result of request.
   */
  std::pair<Result, Gimbal::ControlStatus>
  get_control_status(int32_t gimbal_id) const;
   ...
   */
  void unsubscribe_attitude(uintptr_t handle_ptr);
