...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/action/action.proto)
...
Action::Action(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<ActionImpl>(system)} {}
...
void Action::goto_location_async(double latitude_deg, double longitude_deg,
                                 float absolute_altitude_m, float yaw_deg,
                                 const ResultCallback callback) {
  _impl->goto_location_async(latitude_deg, longitude_deg, absolute_altitude_m,
                             yaw_deg, callback);
}

Action::Result Action::goto_location(double latitude_deg, double longitude_deg,
                                     float absolute_altitude_m,
                                     float yaw_deg) const {
  return _impl->goto_location(latitude_deg, longitude_deg, absolute_altitude_m,
                              yaw_deg);
}

void Action::do_orbit_async(float radius_m, float velocity_ms,
                            OrbitYawBehavior yaw_behavior, double latitude_deg,
                            double longitude_deg, double absolute_altitude_m,
                            const ResultCallback callback) {
  _impl->do_orbit_async(radius_m, velocity_ms, yaw_behavior, latitude_deg,
                        longitude_deg, absolute_altitude_m, callback);
}

Action::Result Action::do_orbit(float radius_m, float velocity_ms,
                                OrbitYawBehavior yaw_behavior,
                                double latitude_deg, double longitude_deg,
                                double absolute_altitude_m) const {
  return _impl->do_orbit(radius_m, velocity_ms, yaw_behavior, latitude_deg,
...
Action::Result Action::hold() const { return _impl->hold(); }

void Action::set_actuator_async(int32_t index, float value,
                                const ResultCallback callback) {
...
void Action::get_takeoff_altitude_async(
...
void Action::set_takeoff_altitude_async(float altitude,
                                        const ResultCallback callback) {
...
Action::Result
Action::set_return_to_launch_altitude(float relative_altitude_m) const {
  return _impl->set_return_to_launch_altitude(relative_altitude_m);
}

void Action::set_current_speed_async(float speed_m_s,
                                     const ResultCallback callback) {
...
Action::Result Action::set_gps_global_origin(double latitude_deg,
                                             double longitude_deg,
                                             float absolute_altitude_m) const {
  return _impl->set_gps_global_origin(latitude_deg, longitude_deg,
                                      absolute_altitude_m);
}
