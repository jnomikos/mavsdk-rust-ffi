...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/action/action.proto)
...
public:
  ...
  enum class OrbitYawBehavior {
    HoldFrontToCircleCenter, /**< @brief Vehicle front points to the center
                                (default). */
    HoldInitialHeading, /**< @brief Vehicle front holds heading when message
                           received. */
    Uncontrolled,       /**< @brief Yaw uncontrolled. */
    HoldFrontTangentToCircle, /**< @brief Vehicle front follows flight path
   ...
   * `Action::OrbitYawBehavior`.
   *
   * @return A reference to the stream.
   */
  friend std::ostream &
  operator<<(std::ostream &str,
             Action::OrbitYawBehavior const &orbit_yaw_behavior);
  ...
  enum class Result {
    ...
    CommandDeniedLandedStateUnknown, /**< @brief Command refused because landed
                                        state is unknown. */
    CommandDeniedNotLanded, /**< @brief Command refused because vehicle not
                               landed. */
    Timeout,                /**< @brief Request timed out. */
    VtolTransitionSupportUnknown, /**< @brief Hybrid/VTOL transition support is
                                     unknown. */
    NoVtolTransitionSupport, /**< @brief Vehicle does not support hybrid/VTOL
                                transitions. */
   ...
   * Before arming take all safety precautions and stand clear of the drone!
   *
   * This function is blocking. See 'arm_async' for the non-blocking
   counterpart.
   *
   ...
   * Before arming take all safety precautions and stand clear of the drone!
   *
   * This function is non-blocking. See 'arm_force' for the blocking
   * counterpart.
   */
   ...
   * Before arming take all safety precautions and stand clear of the drone!
   *
   * This function is blocking. See 'arm_force_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This will disarm a drone that considers itself landed. If flying, the drone
   * should reject the disarm command. Disarming means that all motors will
   * stop.
   *
   ...
   *
   * This function is blocking. See 'disarm_async' for the non-blocking
   counterpart.
   *
   ...
   * Note that the vehicle must be armed before it can take off.
   *
   * This function is blocking. See 'takeoff_async' for the non-blocking
   counterpart.
   *
   ...
   * This switches the drone to 'Land' flight mode.
   *
   * This function is blocking. See 'land_async' for the non-blocking
   counterpart.
   *
   ...
   * This will reboot the autopilot, companion computer, camera and gimbal.
   *
   * This function is blocking. See 'reboot_async' for the non-blocking
   counterpart.
   *
   ...
   * This command should only be used when the autopilot is disarmed and
   * autopilots commonly reject it if they are not already ready to shut down.
   *
   ...
   *
   * This function is blocking. See 'shutdown_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This will run the terminate routine as configured on the drone (e.g. disarm
   * and open the parachute).
   *
   * This function is non-blocking. See 'terminate' for the blocking
   * counterpart.
   */
   ...
   * This will run the terminate routine as configured on the drone (e.g. disarm
   and open the parachute).
   *
   * This function is blocking. See 'terminate_async' for the non-blocking
   counterpart.
   *
   ...
   * Note that the drone will fall out of the sky if this command is used while
   * flying.
   *
   ...
   * Note that the drone will fall out of the sky if this command is used while
   flying.
   *
   * This function is blocking. See 'kill_async' for the non-blocking
   counterpart.
   *
   ...
   * obstacles before heading back to the launch (takeoff) position and land
   * there.
   *
   * This function is non-blocking. See 'return_to_launch' for the blocking
   * counterpart.
   */
   ...
   * This switches the drone into [Return
   mode](https://docs.px4.io/master/en/flight_modes/return.html) which
   * generally means it will rise up to a certain altitude to clear any
   obstacles before heading
   * back to the launch (takeoff) position and land there.
   *
   * This function is blocking. See 'return_to_launch_async' for the
   ...
   *
   * The latitude and longitude are given in degrees (WGS84 frame) and the
   * altitude in meters AMSL (above mean sea level).
   *
   * The yaw angle is in degrees (frame is NED, 0 is North, positive is
   * clockwise).
   *
   * This function is non-blocking. See 'goto_location' for the blocking
   * counterpart.
   */
  void goto_location_async(double latitude_deg, double longitude_deg,
                           float absolute_altitude_m, float yaw_deg,
   ...
   * The yaw angle is in degrees (frame is NED, 0 is North, positive is
   clockwise).
   *
   * This function is blocking. See 'goto_location_async' for the non-blocking
   counterpart.
   *
   ...
   */
  Result goto_location(double latitude_deg, double longitude_deg,
   ...
   */
  void do_orbit_async(float radius_m, float velocity_ms,
                      OrbitYawBehavior yaw_behavior, double latitude_deg,
                      double longitude_deg, double absolute_altitude_m,
                      const ResultCallback callback);
   ...
   * This will run the orbit routine with the given parameters.
   *
   * This function is blocking. See 'do_orbit_async' for the non-blocking
   counterpart.
   *
   ...
   */
  Result do_orbit(float radius_m, float velocity_ms,
                  OrbitYawBehavior yaw_behavior, double latitude_deg,
                  double longitude_deg, double absolute_altitude_m) const;
   ...
   * it implies a change to a PX4-specific mode.
   *
   * This function is blocking. See 'hold_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * Note that the index of the actuator starts at 1 and that the value goes
   * from -1 to 1.
   *
   * This function is non-blocking. See 'set_actuator' for the blocking
   * counterpart.
   */
  void set_actuator_async(int32_t index, float value,
                          const ResultCallback callback);
   ...
   * Note that the index of the actuator starts at 1 and that the value goes
   from -1 to 1.
   *
   * This function is blocking. See 'set_actuator_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * The associated action will only be executed for VTOL vehicles (on other
   * vehicle types the command will fail). The command will succeed if called
   * when the vehicle is already in fixedwing mode.
   *
   * This function is non-blocking. See 'transition_to_fixedwing' for the
   ...
   *
   * This function is blocking. See 'transition_to_fixedwing_async' for the
   non-blocking counterpart.
   *
   ...
   * The associated action will only be executed for VTOL vehicles (on other
   * vehicle types the command will fail). The command will succeed if called
   * when the vehicle is already in multicopter mode.
   *
   * This function is non-blocking. See 'transition_to_multicopter' for the
   * blocking counterpart.
   */
   ...
   *
   * This function is blocking. See 'transition_to_multicopter_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'get_takeoff_altitude' for the blocking
   * counterpart.
   */
   ...
   * @brief Get the takeoff altitude (in meters above ground).
   *
   * This function is blocking. See 'get_takeoff_altitude_async' for the
   * non-blocking counterpart.
   *
   * @return Result of request.
   */
   ...
   *
   * This function is non-blocking. See 'set_takeoff_altitude' for the blocking
   * counterpart.
   */
  void set_takeoff_altitude_async(float altitude,
                                  const ResultCallback callback);

  /**
   * @brief Set takeoff altitude (in meters above ground).
   *
   * This function is blocking. See 'set_takeoff_altitude_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'get_return_to_launch_altitude' for the
   * blocking counterpart.
   */
   ...
   * @brief Get the return to launch minimum return altitude (in meters).
   *
   * This function is blocking. See 'get_return_to_launch_altitude_async' for
   ...
   *
   * This function is non-blocking. See 'set_return_to_launch_altitude' for the
   * blocking counterpart.
   */
  void set_return_to_launch_altitude_async(float relative_altitude_m,
                                           const ResultCallback callback);

  /**
   * @brief Set the return to launch minimum return altitude (in meters).
   *
   * This function is blocking. See 'set_return_to_launch_altitude_async' for
   the non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_current_speed' for the blocking
   * counterpart.
   */
   ...
   * It is ephemeral, so not stored on the drone and does not survive a reboot.
   *
   * This function is blocking. See 'set_current_speed_async' for the
   non-blocking counterpart.
   *
   ...
   */
  Result set_gps_global_origin(double latitude_deg, double longitude_deg,
