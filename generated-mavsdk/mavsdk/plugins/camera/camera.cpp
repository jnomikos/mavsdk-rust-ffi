...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/camera/camera.proto)
...
Camera::Camera(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<CameraImpl>(system)} {}

Camera::~Camera() {}

void Camera::take_photo_async(int32_t component_id,
...
void Camera::start_photo_interval_async(int32_t component_id, float interval_s,
                                        const ResultCallback callback) {
  _impl->start_photo_interval_async(component_id, interval_s, callback);
}

Camera::Result Camera::start_photo_interval(int32_t component_id,
                                            float interval_s) const {
  return _impl->start_photo_interval(component_id, interval_s);
}

void Camera::stop_photo_interval_async(int32_t component_id,
                                       const ResultCallback callback) {
...
void Camera::start_video_async(int32_t component_id,
                               const ResultCallback callback) {
...
void Camera::stop_video_async(int32_t component_id,
                              const ResultCallback callback) {
...
Camera::Result Camera::start_video_streaming(int32_t component_id,
                                             int32_t stream_id) const {
  return _impl->start_video_streaming(component_id, stream_id);
}

Camera::Result Camera::stop_video_streaming(int32_t component_id,
                                            int32_t stream_id) const {
  return _impl->stop_video_streaming(component_id, stream_id);
}

void Camera::set_mode_async(int32_t component_id, Mode mode,
                            const ResultCallback callback) {
...
void Camera::list_photos_async(int32_t component_id, PhotosRange photos_range,
...
void Camera::unsubscribe_camera_list(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<CameraListHandle *>(handle_ptr);
  _impl->unsubscribe_camera_list(*handle);
  delete handle;
}

Camera::CameraListHandle
Camera::subscribe_camera_list(const CameraListCallback &callback) {
...
void Camera::unsubscribe_mode(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ModeHandle *>(handle_ptr);
...
std::pair<Camera::Result, Camera::Mode>
Camera::get_mode(int32_t component_id) const {
...
void Camera::unsubscribe_video_stream_info(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<VideoStreamInfoHandle *>(handle_ptr);
...
void Camera::unsubscribe_capture_info(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<CaptureInfoHandle *>(handle_ptr);
  _impl->unsubscribe_capture_info(*handle);
  delete handle;
}

Camera::CaptureInfoHandle
Camera::subscribe_capture_info(const CaptureInfoCallback &callback) {
...
void Camera::unsubscribe_storage(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<StorageHandle *>(handle_ptr);
  _impl->unsubscribe_storage(*handle);
  delete handle;
}

Camera::StorageHandle
Camera::subscribe_storage(const StorageCallback &callback) {
...
std::pair<Camera::Result, Camera::Storage>
Camera::get_storage(int32_t component_id) const {
...
void Camera::unsubscribe_current_settings(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<CurrentSettingsHandle *>(handle_ptr);
...
void Camera::unsubscribe_possible_setting_options(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<PossibleSettingOptionsHandle *>(handle_ptr);
  _impl->unsubscribe_possible_setting_options(*handle);
  delete handle;
}

Camera::PossibleSettingOptionsHandle Camera::subscribe_possible_setting_options(
    const PossibleSettingOptionsCallback &callback) {
  return _impl->subscribe_possible_setting_options(callback);
}

void Camera::unsubscribe_possible_setting_options(
...
void Camera::set_setting_async(int32_t component_id, Setting setting,
                               const ResultCallback callback) {
  _impl->set_setting_async(component_id, setting, callback);
}

Camera::Result Camera::set_setting(int32_t component_id,
                                   Setting setting) const {
  return _impl->set_setting(component_id, setting);
}

void Camera::get_setting_async(int32_t component_id, Setting setting,
...
void Camera::format_storage_async(int32_t component_id, int32_t storage_id,
                                  const ResultCallback callback) {
  _impl->format_storage_async(component_id, storage_id, callback);
}

Camera::Result Camera::format_storage(int32_t component_id,
                                      int32_t storage_id) const {
  return _impl->format_storage(component_id, storage_id);
}

void Camera::reset_settings_async(int32_t component_id,
                                  const ResultCallback callback) {
...
void Camera::zoom_in_start_async(int32_t component_id,
                                 const ResultCallback callback) {
...
void Camera::zoom_out_start_async(int32_t component_id,
                                  const ResultCallback callback) {
...
void Camera::zoom_stop_async(int32_t component_id,
                             const ResultCallback callback) {
...
void Camera::zoom_range_async(int32_t component_id, float range,
                              const ResultCallback callback) {
...
void Camera::track_point_async(int32_t component_id, float point_x,
                               float point_y, float radius,
                               const ResultCallback callback) {
  _impl->track_point_async(component_id, point_x, point_y, radius, callback);
}

Camera::Result Camera::track_point(int32_t component_id, float point_x,
                                   float point_y, float radius) const {
  return _impl->track_point(component_id, point_x, point_y, radius);
}

void Camera::track_rectangle_async(int32_t component_id, float top_left_x,
                                   float top_left_y, float bottom_right_x,
                                   float bottom_right_y,
                                   const ResultCallback callback) {
  _impl->track_rectangle_async(component_id, top_left_x, top_left_y,
                               bottom_right_x, bottom_right_y, callback);
}

Camera::Result Camera::track_rectangle(int32_t component_id, float top_left_x,
                                       float top_left_y, float bottom_right_x,
                                       float bottom_right_y) const {
  return _impl->track_rectangle(component_id, top_left_x, top_left_y,
                                bottom_right_x, bottom_right_y);
}

void Camera::track_stop_async(int32_t component_id,
                              const ResultCallback callback) {
...
void Camera::focus_in_start_async(int32_t component_id,
                                  const ResultCallback callback) {
...
void Camera::focus_out_start_async(int32_t component_id,
                                   const ResultCallback callback) {
...
void Camera::focus_stop_async(int32_t component_id,
                              const ResultCallback callback) {
...
void Camera::focus_range_async(int32_t component_id, float range,
                               const ResultCallback callback) {
...
bool operator==(const Camera::Option &lhs, const Camera::Option &rhs) {
  return (rhs.option_id == lhs.option_id) &&
...
bool operator==(const Camera::Setting &lhs, const Camera::Setting &rhs) {
  return (rhs.setting_id == lhs.setting_id) &&
         ...
         (rhs.option == lhs.option) && (rhs.is_range == lhs.is_range);
}
...
std::ostream &operator<<(std::ostream &str,
  ...
  str << "    setting_description: " << setting_options.setting_description
      << '\n';
  str << "    options: [";
  for (auto it = setting_options.options.begin();
       it != setting_options.options.end(); ++it) {
    str << *it;
...
bool operator==(const Camera::VideoStreamSettings &lhs,
  ...
  return ((std::isnan(rhs.frame_rate_hz) && std::isnan(lhs.frame_rate_hz)) ||
         ...
         (rhs.rotation_deg == lhs.rotation_deg) && (rhs.uri == lhs.uri) &&
         ((std::isnan(rhs.horizontal_fov_deg) &&
           std::isnan(lhs.horizontal_fov_deg)) ||
...
operator<<(std::ostream &str,
  ...
  str << "    horizontal_resolution_pix: "
      << video_stream_settings.horizontal_resolution_pix << '\n';
  str << "    vertical_resolution_pix: "
...
bool operator==(const Camera::VideoStreamInfo &lhs,
...
bool operator==(const Camera::VideoStreamUpdate &lhs,
...
std::ostream &operator<<(std::ostream &str,
                         Camera::Storage::StorageStatus const &storage_status) {
...
bool operator==(const Camera::Storage &lhs, const Camera::Storage &rhs) {
  return (rhs.component_id == lhs.component_id) &&
         ...
         ((std::isnan(rhs.used_storage_mib) &&
...
bool operator==(const Camera::StorageUpdate &lhs,
...
bool operator==(const Camera::CurrentSettingsUpdate &lhs,
...
operator<<(std::ostream &str,
  ...
  for (auto it = current_settings_update.current_settings.begin();
       it != current_settings_update.current_settings.end(); ++it) {
    str << *it;
...
bool operator==(const Camera::PossibleSettingOptionsUpdate &lhs,
...
std::ostream &operator<<(std::ostream &str,
  ...
  for (auto it = possible_setting_options_update.setting_options.begin();
       it != possible_setting_options_update.setting_options.end(); ++it) {
    str << *it;
...
bool operator==(const Camera::CaptureInfo &lhs,
...
bool operator==(const Camera::Information &lhs,
...
std::ostream &operator<<(std::ostream &str,
  ...
  str << "camera_list:" << '\n' << "{\n";
  str << "    cameras: [";
  for (auto it = camera_list.cameras.begin(); it != camera_list.cameras.end();
       ++it) {
    str << *it;
