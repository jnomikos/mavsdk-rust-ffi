...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/geofence/geofence.proto)
...
public:
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Geofence::FenceType const &fence_type);
   ...
   */
  friend bool operator==(const Geofence::Point &lhs,
                         const Geofence::Point &rhs);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Geofence::Polygon &lhs,
                         const Geofence::Polygon &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Geofence::Polygon const &polygon);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Geofence::Circle &lhs,
                         const Geofence::Circle &rhs);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Geofence::GeofenceData &lhs,
                         const Geofence::GeofenceData &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Geofence::GeofenceData const &geofence_data);
   ...
   *
   * Polygon and Circular geofences are uploaded to a drone. Once uploaded, the
   * geofence will remain on the drone even if a connection is lost.
   *
   * This function is non-blocking. See 'upload_geofence' for the blocking
   * counterpart.
   */
  void upload_geofence_async(GeofenceData geofence_data,
   ...
   *
   * This function is non-blocking. See 'clear_geofence' for the blocking
   * counterpart.
   */
   ...
   * @brief Clear all geofences saved on the vehicle.
   *
   * This function is blocking. See 'clear_geofence_async' for the non-blocking
   counterpart.
   *
