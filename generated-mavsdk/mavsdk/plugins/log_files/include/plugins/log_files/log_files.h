...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/log_files/log_files.proto)
...
/**
 * @brief Allow to download log files from the vehicle after a flight is
 * complete. For log streaming during flight check the logging plugin.
 */
...
public:
   ...
   */
  friend bool operator==(const LogFiles::ProgressData &lhs,
                         const LogFiles::ProgressData &rhs);
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  LogFiles::ProgressData const &progress_data);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const LogFiles::Entry &lhs,
                         const LogFiles::Entry &rhs);
   ...
   *
   * This function is non-blocking. See 'get_entries' for the blocking
   * counterpart.
   */
   ...
   * @brief Get List of log files.
   *
   * This function is blocking. See 'get_entries_async' for the non-blocking
   * counterpart.
   *
