...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/failure/failure.proto)
...
Failure::Failure(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<FailureImpl>(system)} {}

Failure::~Failure() {}

Failure::Result Failure::inject(FailureUnit failure_unit,
