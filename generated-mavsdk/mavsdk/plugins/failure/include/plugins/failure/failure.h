...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/failure/failure.proto)
...
public:
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Failure::FailureUnit const &failure_unit);
  ...
  enum class FailureType {
    ...
    Slow,    /**< @brief Unit is slow, so e.g. reporting at slower than expected
                rate. */
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Failure::FailureType const &failure_type);
   ...
   */
  Result inject(FailureUnit failure_unit, FailureType failure_type,
