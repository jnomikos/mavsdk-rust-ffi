...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/winch/winch.proto)
...
/**
 * @brief Allows users to send winch actions, as well as receive status
 * information from winch systems.
 */
...
public:
  ...
  enum class WinchAction {
    ...
    RelativeLengthControl, /**< @brief Wind or unwind specified length of line,
                              optionally using specified rate. */
    RateControl,           /**< @brief Wind or unwind line at specified rate. */
    Lock, /**< @brief Perform the locking sequence to relieve motor while in the
    ...
    LoadLine, /**< @brief Load the reel with line. The winch will calculate the
                 total loaded length and stop when the tension exceeds a
                 threshold. */
    AbandonLine, /**< @brief Spool out the entire length of the line. */
    LoadPayload, /**< @brief Spools out just enough to present the hook to the
                    user to load the payload. */
  };
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Winch::WinchAction const &winch_action);
   ...
   */
  friend bool operator==(const Winch::StatusFlags &lhs,
                         const Winch::StatusFlags &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Winch::StatusFlags const &status_flags);
   ...
   */
  void unsubscribe_status(uintptr_t handle_ptr);
   ...
   * @brief Allow motor to freewheel.
   *
   * This function is blocking. See 'relax_async' for the non-blocking
   counterpart.
   *
  ...
  /**
   * @brief Wind or unwind specified length of line, optionally using specified
   * rate.
   *
   * This function is non-blocking. See 'relative_length_control' for the
   * blocking counterpart.
   */
  void relative_length_control_async(uint32_t instance, float length_m,
                                     float rate_m_s,
   ...
   * @brief Wind or unwind specified length of line, optionally using specified
   rate.
   *
   * This function is blocking. See 'relative_length_control_async' for the
   ...
   */
  Result relative_length_control(uint32_t instance, float length_m,
                                 float rate_m_s) const;

  /**
   * @brief Wind or unwind line at specified rate.
   *
   * This function is non-blocking. See 'rate_control' for the blocking
   * counterpart.
   */
  void rate_control_async(uint32_t instance, float rate_m_s,
                          const ResultCallback callback);

  /**
   * @brief Wind or unwind line at specified rate.
   *
   * This function is blocking. See 'rate_control_async' for the non-blocking
   counterpart.
   *
  ...
  /**
   * @brief Perform the locking sequence to relieve motor while in the fully
   * retracted position.
   *
   ...
   * @brief Perform the locking sequence to relieve motor while in the fully
   retracted position.
   *
   * This function is blocking. See 'lock_async' for the non-blocking
   counterpart.
   *
   ...
   * @brief Sequence of drop, slow down, touch down, reel up, lock.
   *
   * This function is blocking. See 'deliver_async' for the non-blocking
   counterpart.
   *
   ...
   * @brief Return the reel to the fully retracted position.
   *
   * This function is blocking. See 'retract_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * The winch will calculate the total loaded length and stop when the tension
   * exceeds a threshold.
   *
   * This function is non-blocking. See 'load_line' for the blocking
   * counterpart.
   */
   ...
   * The winch will calculate the total loaded length and stop when the tension
   exceeds a threshold.
   *
   * This function is blocking. See 'load_line_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'abandon_line' for the blocking
   * counterpart.
   */
   ...
   * @brief Spool out the entire length of the line.
   *
   * This function is blocking. See 'abandon_line_async' for the non-blocking
   counterpart.
   *
  ...
  /**
   * @brief Spools out just enough to present the hook to the user to load the
   * payload.
   *
   * This function is non-blocking. See 'load_payload' for the blocking
   * counterpart.
   */
   ...
   * @brief Spools out just enough to present the hook to the user to load the
   payload.
   *
   * This function is blocking. See 'load_payload_async' for the non-blocking
   counterpart.
   *
