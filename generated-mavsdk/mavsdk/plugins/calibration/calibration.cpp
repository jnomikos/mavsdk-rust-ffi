...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/calibration/calibration.proto)
...
Calibration::Calibration(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<CalibrationImpl>(system)} {}
...
Calibration::Result Calibration::cancel() const { return _impl->cancel(); }
...
bool operator==(const Calibration::ProgressData &lhs,
...
std::ostream &operator<<(std::ostream &str,
                         Calibration::ProgressData const &progress_data) {
