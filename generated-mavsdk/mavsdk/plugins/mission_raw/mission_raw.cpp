...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/mission_raw/mission_raw.proto)
...
MissionRaw::MissionRaw(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<MissionRawImpl>(system)} {}

MissionRaw::~MissionRaw() {}

void MissionRaw::upload_mission_async(std::vector<MissionItem> mission_items,
                                      const ResultCallback callback) {
  _impl->upload_mission_async(mission_items, callback);
}

MissionRaw::Result
MissionRaw::upload_mission(std::vector<MissionItem> mission_items) const {
  return _impl->upload_mission(mission_items);
}

void MissionRaw::upload_geofence_async(std::vector<MissionItem> mission_items,
                                       const ResultCallback callback) {
  _impl->upload_geofence_async(mission_items, callback);
}

MissionRaw::Result
MissionRaw::upload_geofence(std::vector<MissionItem> mission_items) const {
...
MissionRaw::Result
MissionRaw::upload_rally_points(std::vector<MissionItem> mission_items) const {
...
void MissionRaw::download_mission_async(
...
void MissionRaw::download_geofence_async(
    const DownloadGeofenceCallback callback) {
...
void MissionRaw::download_rallypoints_async(
    const DownloadRallypointsCallback callback) {
...
void MissionRaw::set_current_mission_item_async(int32_t index,
                                                const ResultCallback callback) {
...
void MissionRaw::unsubscribe_mission_progress(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<MissionProgressHandle *>(handle_ptr);
  _impl->unsubscribe_mission_progress(*handle);
  delete handle;
}

MissionRaw::MissionProgressHandle MissionRaw::subscribe_mission_progress(
...
void MissionRaw::unsubscribe_mission_changed(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<MissionChangedHandle *>(handle_ptr);
...
std::pair<MissionRaw::Result, MissionRaw::MissionImportData>
MissionRaw::import_qgroundcontrol_mission_from_string(
    std::string qgc_plan) const {
  return _impl->import_qgroundcontrol_mission_from_string(qgc_plan);
}

std::pair<MissionRaw::Result, MissionRaw::MissionImportData>
MissionRaw::import_mission_planner_mission(
    std::string mission_planner_path) const {
  return _impl->import_mission_planner_mission(mission_planner_path);
}

std::pair<MissionRaw::Result, MissionRaw::MissionImportData>
MissionRaw::import_mission_planner_mission_from_string(
    std::string mission_planner_mission) const {
  return _impl->import_mission_planner_mission_from_string(
...
bool operator==(const MissionRaw::MissionProgress &lhs,
...
bool operator==(const MissionRaw::MissionItem &lhs,
...
bool operator==(const MissionRaw::MissionImportData &lhs,
