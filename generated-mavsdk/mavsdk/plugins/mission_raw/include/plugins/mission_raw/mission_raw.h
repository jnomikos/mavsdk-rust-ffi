...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/mission_raw/mission_raw.proto)
...
public:
   ...
   */
  friend bool operator==(const MissionRaw::MissionProgress &lhs,
                         const MissionRaw::MissionProgress &rhs);
  ...
  operator<<(std::ostream &str,
             MissionRaw::MissionProgress const &mission_progress);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const MissionRaw::MissionItem &lhs,
                         const MissionRaw::MissionItem &rhs);
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  MissionRaw::MissionItem const &mission_item);
  ...
  /**
   * @brief Equal operator to compare two `MissionRaw::MissionImportData`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const MissionRaw::MissionImportData &lhs,
                         const MissionRaw::MissionImportData &rhs);
  ...
  friend std::ostream &
  operator<<(std::ostream &str,
             MissionRaw::MissionImportData const &mission_import_data);
  ...
  enum class Result {
    ...
    Unsupported,          /**< @brief Mission downloaded from the system is not
                             supported. */
    NoMissionAvailable,   /**< @brief No mission available on the system. */
    TransferCancelled,    /**< @brief Mission transfer (upload or download) has
                             been cancelled. */
    ...
    InvalidSequence, /**< @brief The mission item sequences are not increasing
                        correctly. */
    CurrentInvalid,  /**< @brief The current item is not set correctly. */
    ProtocolError,   /**< @brief There was a protocol error. */
    IntMessagesNotSupported,         /**< @brief The system does not support the
                                        MISSION_INT protocol. */
    FailedToOpenMissionPlannerPlan,  /**< @brief Failed to open the Mission
                                        Planner plan. */
    FailedToParseMissionPlannerPlan, /**< @brief Failed to parse the Mission
                                        Planner plan. */
  };
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  MissionRaw::Result const &result);
   ...
   *
   * This function is non-blocking. See 'upload_mission' for the blocking
   * counterpart.
   */
  void upload_mission_async(std::vector<MissionItem> mission_items,
   ...
   * can be started and executed even if the connection is lost.
   *
   * This function is blocking. See 'upload_mission_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'upload_geofence' for the blocking
   * counterpart.
   */
  void upload_geofence_async(std::vector<MissionItem> mission_items,
                             const ResultCallback callback);

  /**
   * @brief Upload a list of geofence items to the system.
   *
   * This function is blocking. See 'upload_geofence_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'upload_rally_points' for the blocking
   * counterpart.
   */
  void upload_rally_points_async(std::vector<MissionItem> mission_items,
                                 const ResultCallback callback);

  /**
   * @brief Upload a list of rally point items to the system.
   *
   * This function is blocking. See 'upload_rally_points_async' for the
   ...
   */
  using DownloadMissionCallback =
      std::function<void(Result, std::vector<MissionItem>)>;

  /**
   * @brief Download a list of raw mission items from the system (asynchronous).
   *
   * This function is non-blocking. See 'download_mission' for the blocking
   * counterpart.
   */
   ...
   * @brief Download a list of raw mission items from the system (asynchronous).
   *
   * This function is blocking. See 'download_mission_async' for the
   * non-blocking counterpart.
   *
   * @return Result of request.
   */
  std::pair<Result, std::vector<MissionRaw::MissionItem>>
  ...
  /**
   * @brief Download a list of raw geofence items from the system
   * (asynchronous).
   *
   * This function is non-blocking. See 'download_geofence' for the blocking
   * counterpart.
   */
   ...
   * (asynchronous).
   *
   * This function is blocking. See 'download_geofence_async' for the
   * non-blocking counterpart.
   *
   * @return Result of request.
   */
  std::pair<Result, std::vector<MissionRaw::MissionItem>>
  download_geofence() const;

  /**
   * @brief Callback type for download_rallypoints_async.
   */
  using DownloadRallypointsCallback =
      std::function<void(Result, std::vector<MissionItem>)>;

  /**
   * @brief Download a list of raw rallypoint items from the system
   * (asynchronous).
   *
   * This function is non-blocking. See 'download_rallypoints' for the blocking
   * counterpart.
   */
   ...
   * (asynchronous).
   *
   * This function is blocking. See 'download_rallypoints_async' for the
   * non-blocking counterpart.
   *
   * @return Result of request.
   */
  std::pair<Result, std::vector<MissionRaw::MissionItem>>
  download_rallypoints() const;
   ...
   *
   * This function is non-blocking. See 'start_mission' for the blocking
   * counterpart.
   */
   ...
   * A mission must be uploaded to the vehicle before this can be called.
   *
   * This function is blocking. See 'start_mission_async' for the non-blocking
   counterpart.
   *
   ...
   * A multicopter should just hover at the spot while a fixedwing vehicle
   * should loiter around the location where it paused.
   *
   * This function is non-blocking. See 'pause_mission' for the blocking
   * counterpart.
   */
   ...
   *
   * This function is blocking. See 'pause_mission_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'clear_mission' for the blocking
   * counterpart.
   */
   ...
   * @brief Clear the mission saved on the vehicle.
   *
   * This function is blocking. See 'clear_mission_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * By setting the current index to 0, the mission is restarted from the
   * beginning. If it is set to a specific index of a raw mission item, the
   * mission will be set to this item.
   *
   * This function is non-blocking. See 'set_current_mission_item' for the
   * blocking counterpart.
   */
  void set_current_mission_item_async(int32_t index,
                                      const ResultCallback callback);
   ...
   *
   * By setting the current index to 0, the mission is restarted from the
   beginning. If it is set
   * to a specific index of a raw mission item, the mission will be set to this
   item.
   *
   * This function is blocking. See 'set_current_mission_item_async' for the
   non-blocking counterpart.
   *
   ...
   */
  void unsubscribe_mission_progress(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_mission_changed(uintptr_t handle_ptr);
  ...
  /**
   * @brief Import a QGroundControl missions in JSON .plan format, from a
   * string.
   *
   * Supported:
   * - Waypoints
  ...
  /**
   * @brief Import a Mission Planner mission in QGC WPL 110 format, from a
   * string.
   *
   * Supported:
   * - Waypoints
  ...
  import_mission_planner_mission_from_string(
      std::string mission_planner_mission) const;
