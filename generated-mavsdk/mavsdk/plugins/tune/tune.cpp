...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/tune/tune.proto)
...
Tune::Tune(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<TuneImpl>(system)} {}

Tune::~Tune() {}

void Tune::play_tune_async(TuneDescription tune_description,
