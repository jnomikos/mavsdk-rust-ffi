...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/tune/tune.proto)
...
public:
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Tune::SongElement const &song_element);
   ...
   */
  friend bool operator==(const Tune::TuneDescription &lhs,
                         const Tune::TuneDescription &rhs);
  ...
  enum class Result {
    ...
    TuneTooLong,  /**< @brief Invalid tune: encoded string must be at most 247
                     chars. */
   ...
   *
   * This function is non-blocking. See 'play_tune' for the blocking
   * counterpart.
   */
  void play_tune_async(TuneDescription tune_description,
                       const ResultCallback callback);

  /**
   * @brief Send a tune to be played by the system.
   *
   * This function is blocking. See 'play_tune_async' for the non-blocking
   counterpart.
   *
