...
public:
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  ManualControl::Result const &result);
   ...
   *
   * This function is non-blocking. See 'start_position_control' for the
   ...
   * Requires a valid position using e.g. GPS, external vision, or optical flow.
   *
   * This function is blocking. See 'start_position_control_async' for the
   ...
   *
   * This function is non-blocking. See 'start_altitude_control' for the
   * blocking counterpart.
   */
   ...
   * Does not require a  valid position e.g. GPS.
   *
   * This function is blocking. See 'start_altitude_control_async' for the
   non-blocking counterpart.
   *
