...
ManualControl::ManualControl(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<ManualControlImpl>(system)} {}

ManualControl::~ManualControl() {}

void ManualControl::start_position_control_async(
...
void ManualControl::start_altitude_control_async(
    const ResultCallback callback) {
...
ManualControl::Result ManualControl::set_manual_control_input(float x, float y,
                                                              float z,
                                                              float r) const {
