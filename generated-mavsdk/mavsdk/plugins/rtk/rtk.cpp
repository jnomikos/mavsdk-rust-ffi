...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/rtk/rtk.proto)
...
Rtk::Rtk(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<RtkImpl>(system)} {}
