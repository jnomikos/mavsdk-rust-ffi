...
public:
  ...
  enum class RejectionReason {
    ...
    Timeout, /**< @brief Timeout in the authorizer process(in case it depends on
                network). */
    AirspaceInUse, /**< @brief Airspace of the mission in use by another
                      vehicle, second result parameter can have the waypoint id
   ...
   * `ArmAuthorizerServer::RejectionReason`.
   *
   * @return A reference to the stream.
   */
  friend std::ostream &
  operator<<(std::ostream &str,
             ArmAuthorizerServer::RejectionReason const &rejection_reason);
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  ArmAuthorizerServer::Result const &result);
   ...
   */
  void unsubscribe_arm_authorization(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to arm authorization request messages. Each request
   * received should respond to using RespondArmAuthorization
   */
  ArmAuthorizationHandle
  subscribe_arm_authorization(const ArmAuthorizationCallback &callback);
   ...
   */
  Result reject_arm_authorization(bool temporarily, RejectionReason reason,
