...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/gripper/gripper.proto)
...
public:
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Gripper::GripperAction const &gripper_action);
   ...
   * @brief Gripper grab cargo.
   *
   * This function is blocking. See 'grab_async' for the non-blocking
   counterpart.
   *
   ...
   * @brief Gripper release cargo.
   *
   * This function is blocking. See 'release_async' for the non-blocking
   counterpart.
   *
