...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/telemetry/telemetry.proto)
 ...
 * rates. Certain Telemetry Topics such as, Position or Velocity_Ned require GPS
 * Fix before data gets published.
 */
...
public:
  ...
  enum class FlightMode {
    ...
    Hold,    /**< @brief Holding (hovering in place (or circling for fixed-wing
                vehicles). */
  ...
  enum class VtolState {
    ...
    TransitionToFw, /**< @brief VTOL is in transition from multicopter to
                       fixed-wing. */
    TransitionToMc, /**< @brief VTOL is in transition from fixed-wing to
                       multicopter. */
   ...
   */
  friend bool operator==(const Telemetry::Position &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Heading &lhs,
                         const Telemetry::Heading &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Telemetry::Heading const &heading);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Quaternion &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::EulerAngle &lhs,
  ...
  /**
   * @brief Equal operator to compare two `Telemetry::AngularVelocityBody`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::AngularVelocityBody &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::GpsInfo &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::RawGps &lhs,
                         const Telemetry::RawGps &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Telemetry::RawGps const &raw_gps);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Battery &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Health &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::RcStatus &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::StatusText &lhs,
  ...
  /**
   * @brief Equal operator to compare two `Telemetry::ActuatorControlTarget`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::ActuatorControlTarget &lhs,
  ...
  /**
   * @brief Equal operator to compare two `Telemetry::ActuatorOutputStatus`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::ActuatorOutputStatus &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Covariance &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::VelocityBody &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::PositionBody &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Odometry &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::DistanceSensor &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::ScaledPressure &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::PositionNed &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::VelocityNed &lhs,
  ...
  /**
   * @brief Equal operator to compare two `Telemetry::PositionVelocityNed`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::PositionVelocityNed &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::GroundTruth &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::FixedwingMetrics &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::AccelerationFrd &lhs,
  ...
  /**
   * @brief Equal operator to compare two `Telemetry::AngularVelocityFrd`
   * objects.
   *
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::AngularVelocityFrd &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::MagneticFieldFrd &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::GpsGlobalOrigin &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Altitude &lhs,
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Telemetry::Wind &lhs,
                         const Telemetry::Wind &rhs);
   ...
   */
  void unsubscribe_position(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_home(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_in_air(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_landed_state(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_armed(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_vtol_state(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_attitude_quaternion(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_attitude_euler(uintptr_t handle_ptr);
   ...
   */
  using AttitudeAngularVelocityBodyCallback =
      std::function<void(AngularVelocityBody)>;
   ...
   */
  void unsubscribe_attitude_angular_velocity_body(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to 'attitude' updates (angular velocity)
   */
  AttitudeAngularVelocityBodyHandle subscribe_attitude_angular_velocity_body(
   ...
   */
  void unsubscribe_velocity_ned(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_gps_info(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_raw_gps(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_battery(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_flight_mode(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_health(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_rc_status(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_status_text(uintptr_t handle_ptr);
   ...
   */
  using ActuatorControlTargetCallback =
      std::function<void(ActuatorControlTarget)>;
   ...
   */
  void unsubscribe_actuator_control_target(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to 'actuator control target' updates.
   */
  ActuatorControlTargetHandle subscribe_actuator_control_target(
   ...
   */
  using ActuatorOutputStatusCallback =
      std::function<void(ActuatorOutputStatus)>;
   ...
   */
  void unsubscribe_actuator_output_status(uintptr_t handle_ptr);

  /**
   * @brief Subscribe to 'actuator output status' updates.
   */
  ActuatorOutputStatusHandle subscribe_actuator_output_status(
   ...
   */
  void unsubscribe_odometry(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_position_velocity_ned(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_ground_truth(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_fixedwing_metrics(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_imu(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_scaled_imu(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_raw_imu(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_health_all_ok(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_unix_epoch_time(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_distance_sensor(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_scaled_pressure(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_heading(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_altitude(uintptr_t handle_ptr);
   ...
   */
  void unsubscribe_wind(uintptr_t handle_ptr);
   ...
   *
   * This function is non-blocking. See 'set_rate_position' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'position' updates.
   *
   * This function is blocking. See 'set_rate_position_async' for the
   ...
   *
   * This function is non-blocking. See 'set_rate_home' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'home position' updates.
   *
   * This function is blocking. See 'set_rate_home_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_in_air' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to in-air updates.
   *
   * This function is blocking. See 'set_rate_in_air_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_landed_state' for the blocking
   * counterpart.
   */
  void set_rate_landed_state_async(double rate_hz,
                                   const ResultCallback callback);

  /**
   * @brief Set rate to landed state updates
   *
   * This function is blocking. See 'set_rate_landed_state_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_vtol_state' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to VTOL state updates
   *
   * This function is blocking. See 'set_rate_vtol_state_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_attitude_quaternion' for the
   * blocking counterpart.
   */
  void set_rate_attitude_quaternion_async(double rate_hz,
                                          const ResultCallback callback);

  /**
   * @brief Set rate to 'attitude euler angle' updates.
   *
   * This function is blocking. See 'set_rate_attitude_quaternion_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_attitude_euler' for the
   * blocking counterpart.
   */
  void set_rate_attitude_euler_async(double rate_hz,
                                     const ResultCallback callback);

  /**
   * @brief Set rate to 'attitude quaternion' updates.
   *
   * This function is blocking. See 'set_rate_attitude_euler_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_velocity_ned' for the blocking
   * counterpart.
   */
  void set_rate_velocity_ned_async(double rate_hz,
                                   const ResultCallback callback);
   ...
   * Set rate to 'ground speed' updates (NED).
   *
   * This function is blocking. See 'set_rate_velocity_ned_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_gps_info' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'GPS info' updates.
   *
   * This function is blocking. See 'set_rate_gps_info_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_battery' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'battery' updates.
   *
   * This function is blocking. See 'set_rate_battery_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_rc_status' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'RC status' updates.
   *
   * This function is blocking. See 'set_rate_rc_status_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_actuator_control_target' for
   * the blocking counterpart.
   */
  void set_rate_actuator_control_target_async(double rate_hz,
                                              const ResultCallback callback);

  /**
   * @brief Set rate to 'actuator control target' updates.
   *
   * This function is blocking. See 'set_rate_actuator_control_target_async' for
   ...
   *
   * This function is non-blocking. See 'set_rate_actuator_output_status' for
   * the blocking counterpart.
   */
  void set_rate_actuator_output_status_async(double rate_hz,
                                             const ResultCallback callback);

  /**
   * @brief Set rate to 'actuator output status' updates.
   *
   * This function is blocking. See 'set_rate_actuator_output_status_async' for
   the non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_odometry' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'odometry' updates.
   *
   * This function is blocking. See 'set_rate_odometry_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_position_velocity_ned' for the
   * blocking counterpart.
   */
   ...
   * @brief Set rate to 'position velocity' updates.
   *
   * This function is blocking. See 'set_rate_position_velocity_ned_async' for
   the non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_ground_truth' for the blocking
   * counterpart.
   */
  void set_rate_ground_truth_async(double rate_hz,
                                   const ResultCallback callback);

  /**
   * @brief Set rate to 'ground truth' updates.
   *
   * This function is blocking. See 'set_rate_ground_truth_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_fixedwing_metrics' for the
   * blocking counterpart.
   */
  void set_rate_fixedwing_metrics_async(double rate_hz,
                                        const ResultCallback callback);

  /**
   * @brief Set rate to 'fixedwing metrics' updates.
   *
   * This function is blocking. See 'set_rate_fixedwing_metrics_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_imu' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'IMU' updates.
   *
   * This function is blocking. See 'set_rate_imu_async' for the non-blocking
   counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_scaled_imu' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'Scaled IMU' updates.
   *
   * This function is blocking. See 'set_rate_scaled_imu_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_raw_imu' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'Raw IMU' updates.
   *
   * This function is blocking. See 'set_rate_raw_imu_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_unix_epoch_time' for the
   * blocking counterpart.
   */
  void set_rate_unix_epoch_time_async(double rate_hz,
                                      const ResultCallback callback);

  /**
   * @brief Set rate to 'unix epoch time' updates.
   *
   * This function is blocking. See 'set_rate_unix_epoch_time_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_distance_sensor' for the
   * blocking counterpart.
   */
  void set_rate_distance_sensor_async(double rate_hz,
                                      const ResultCallback callback);

  /**
   * @brief Set rate to 'Distance Sensor' updates.
   *
   * This function is blocking. See 'set_rate_distance_sensor_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_altitude' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'Altitude' updates.
   *
   * This function is blocking. See 'set_rate_altitude_async' for the
   non-blocking counterpart.
   *
   ...
   *
   * This function is non-blocking. See 'set_rate_health' for the blocking
   * counterpart.
   */
   ...
   * @brief Set rate to 'Health' updates.
   *
   * This function is blocking. See 'set_rate_health_async' for the non-blocking
   counterpart.
   *
   ...
   */
  using GetGpsGlobalOriginCallback =
      std::function<void(Result, GpsGlobalOrigin)>;

  /**
   * @brief Get the GPS location of where the estimator has been initialized.
   *
   * This function is non-blocking. See 'get_gps_global_origin' for the blocking
   * counterpart.
   */
   ...
   * @brief Get the GPS location of where the estimator has been initialized.
   *
   * This function is blocking. See 'get_gps_global_origin_async' for the
   * non-blocking counterpart.
   *
   * @return Result of request.
   */
