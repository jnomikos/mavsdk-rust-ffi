...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/telemetry/telemetry.proto)
...
Telemetry::Telemetry(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<TelemetryImpl>(system)} {}
...
void Telemetry::unsubscribe_position(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<PositionHandle *>(handle_ptr);
  _impl->unsubscribe_position(*handle);
  delete handle;
}

Telemetry::PositionHandle
Telemetry::subscribe_position(const PositionCallback &callback) {
...
void Telemetry::unsubscribe_home(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<HomeHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_in_air(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<InAirHandle *>(handle_ptr);
  _impl->unsubscribe_in_air(*handle);
  delete handle;
}

Telemetry::InAirHandle
Telemetry::subscribe_in_air(const InAirCallback &callback) {
...
void Telemetry::unsubscribe_landed_state(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<LandedStateHandle *>(handle_ptr);
  _impl->unsubscribe_landed_state(*handle);
  delete handle;
}

Telemetry::LandedStateHandle
Telemetry::subscribe_landed_state(const LandedStateCallback &callback) {
...
void Telemetry::unsubscribe_armed(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ArmedHandle *>(handle_ptr);
  _impl->unsubscribe_armed(*handle);
  delete handle;
}

Telemetry::ArmedHandle
Telemetry::subscribe_armed(const ArmedCallback &callback) {
...
void Telemetry::unsubscribe_vtol_state(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<VtolStateHandle *>(handle_ptr);
  _impl->unsubscribe_vtol_state(*handle);
  delete handle;
}

Telemetry::VtolStateHandle
Telemetry::subscribe_vtol_state(const VtolStateCallback &callback) {
...
void Telemetry::unsubscribe_attitude_quaternion(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<AttitudeQuaternionHandle *>(handle_ptr);
  _impl->unsubscribe_attitude_quaternion(*handle);
  delete handle;
}

Telemetry::AttitudeQuaternionHandle Telemetry::subscribe_attitude_quaternion(
    const AttitudeQuaternionCallback &callback) {
  return _impl->subscribe_attitude_quaternion(callback);
}

void Telemetry::unsubscribe_attitude_quaternion(
...
void Telemetry::unsubscribe_attitude_euler(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<AttitudeEulerHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_attitude_angular_velocity_body(
    uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle =
      reinterpret_cast<AttitudeAngularVelocityBodyHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_velocity_ned(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<VelocityNedHandle *>(handle_ptr);
  _impl->unsubscribe_velocity_ned(*handle);
  delete handle;
}

Telemetry::VelocityNedHandle
Telemetry::subscribe_velocity_ned(const VelocityNedCallback &callback) {
...
void Telemetry::unsubscribe_gps_info(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<GpsInfoHandle *>(handle_ptr);
  _impl->unsubscribe_gps_info(*handle);
  delete handle;
}

Telemetry::GpsInfoHandle
Telemetry::subscribe_gps_info(const GpsInfoCallback &callback) {
...
void Telemetry::unsubscribe_raw_gps(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<RawGpsHandle *>(handle_ptr);
  _impl->unsubscribe_raw_gps(*handle);
  delete handle;
}

Telemetry::RawGpsHandle
Telemetry::subscribe_raw_gps(const RawGpsCallback &callback) {
...
void Telemetry::unsubscribe_battery(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<BatteryHandle *>(handle_ptr);
  _impl->unsubscribe_battery(*handle);
  delete handle;
}

Telemetry::BatteryHandle
Telemetry::subscribe_battery(const BatteryCallback &callback) {
...
void Telemetry::unsubscribe_flight_mode(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<FlightModeHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_health(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<HealthHandle *>(handle_ptr);
  _impl->unsubscribe_health(*handle);
  delete handle;
}

Telemetry::HealthHandle
Telemetry::subscribe_health(const HealthCallback &callback) {
...
void Telemetry::unsubscribe_rc_status(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<RcStatusHandle *>(handle_ptr);
  _impl->unsubscribe_rc_status(*handle);
  delete handle;
}

Telemetry::RcStatusHandle
Telemetry::subscribe_rc_status(const RcStatusCallback &callback) {
...
void Telemetry::unsubscribe_status_text(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<StatusTextHandle *>(handle_ptr);
  _impl->unsubscribe_status_text(*handle);
  delete handle;
}

Telemetry::StatusTextHandle
Telemetry::subscribe_status_text(const StatusTextCallback &callback) {
...
void Telemetry::unsubscribe_actuator_control_target(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ActuatorControlTargetHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_actuator_control_target(
...
void Telemetry::unsubscribe_actuator_output_status(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ActuatorOutputStatusHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_actuator_output_status(
...
void Telemetry::unsubscribe_odometry(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<OdometryHandle *>(handle_ptr);
  _impl->unsubscribe_odometry(*handle);
  delete handle;
}

Telemetry::OdometryHandle
Telemetry::subscribe_odometry(const OdometryCallback &callback) {
...
void Telemetry::unsubscribe_position_velocity_ned(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<PositionVelocityNedHandle *>(handle_ptr);
  _impl->unsubscribe_position_velocity_ned(*handle);
  delete handle;
}

Telemetry::PositionVelocityNedHandle Telemetry::subscribe_position_velocity_ned(
    const PositionVelocityNedCallback &callback) {
  return _impl->subscribe_position_velocity_ned(callback);
}

void Telemetry::unsubscribe_position_velocity_ned(
...
void Telemetry::unsubscribe_ground_truth(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<GroundTruthHandle *>(handle_ptr);
  _impl->unsubscribe_ground_truth(*handle);
  delete handle;
}

Telemetry::GroundTruthHandle
Telemetry::subscribe_ground_truth(const GroundTruthCallback &callback) {
...
void Telemetry::unsubscribe_fixedwing_metrics(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<FixedwingMetricsHandle *>(handle_ptr);
  _impl->unsubscribe_fixedwing_metrics(*handle);
  delete handle;
}

Telemetry::FixedwingMetricsHandle Telemetry::subscribe_fixedwing_metrics(
...
void Telemetry::unsubscribe_imu(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ImuHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_scaled_imu(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ScaledImuHandle *>(handle_ptr);
  _impl->unsubscribe_scaled_imu(*handle);
  delete handle;
}

Telemetry::ScaledImuHandle
Telemetry::subscribe_scaled_imu(const ScaledImuCallback &callback) {
...
void Telemetry::unsubscribe_raw_imu(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<RawImuHandle *>(handle_ptr);
  _impl->unsubscribe_raw_imu(*handle);
  delete handle;
}

Telemetry::RawImuHandle
Telemetry::subscribe_raw_imu(const RawImuCallback &callback) {
...
void Telemetry::unsubscribe_health_all_ok(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<HealthAllOkHandle *>(handle_ptr);
  _impl->unsubscribe_health_all_ok(*handle);
  delete handle;
}

Telemetry::HealthAllOkHandle
Telemetry::subscribe_health_all_ok(const HealthAllOkCallback &callback) {
...
void Telemetry::unsubscribe_unix_epoch_time(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<UnixEpochTimeHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_distance_sensor(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<DistanceSensorHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_scaled_pressure(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<ScaledPressureHandle *>(handle_ptr);
...
void Telemetry::unsubscribe_heading(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<HeadingHandle *>(handle_ptr);
  _impl->unsubscribe_heading(*handle);
  delete handle;
}

Telemetry::HeadingHandle
Telemetry::subscribe_heading(const HeadingCallback &callback) {
...
void Telemetry::unsubscribe_altitude(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<AltitudeHandle *>(handle_ptr);
  _impl->unsubscribe_altitude(*handle);
  delete handle;
}

Telemetry::AltitudeHandle
Telemetry::subscribe_altitude(const AltitudeCallback &callback) {
...
void Telemetry::unsubscribe_wind(uintptr_t handle_ptr) {
  if (!handle_ptr) {
    return;
  }
  auto handle = reinterpret_cast<WindHandle *>(handle_ptr);
...
Telemetry::Wind Telemetry::wind() const { return _impl->wind(); }

void Telemetry::set_rate_position_async(double rate_hz,
...
void Telemetry::set_rate_home_async(double rate_hz,
                                    const ResultCallback callback) {
...
void Telemetry::set_rate_in_air_async(double rate_hz,
                                      const ResultCallback callback) {
...
void Telemetry::set_rate_landed_state_async(double rate_hz,
                                            const ResultCallback callback) {
...
void Telemetry::set_rate_vtol_state_async(double rate_hz,
                                          const ResultCallback callback) {
...
void Telemetry::set_rate_attitude_quaternion_async(
    double rate_hz, const ResultCallback callback) {
  _impl->set_rate_attitude_quaternion_async(rate_hz, callback);
}

Telemetry::Result
Telemetry::set_rate_attitude_quaternion(double rate_hz) const {
  return _impl->set_rate_attitude_quaternion(rate_hz);
}

void Telemetry::set_rate_attitude_euler_async(double rate_hz,
                                              const ResultCallback callback) {
...
void Telemetry::set_rate_velocity_ned_async(double rate_hz,
                                            const ResultCallback callback) {
...
void Telemetry::set_rate_gps_info_async(double rate_hz,
                                        const ResultCallback callback) {
...
void Telemetry::set_rate_battery_async(double rate_hz,
                                       const ResultCallback callback) {
...
Telemetry::Result
Telemetry::set_rate_actuator_control_target(double rate_hz) const {
...
Telemetry::Result
Telemetry::set_rate_actuator_output_status(double rate_hz) const {
...
Telemetry::Result
Telemetry::set_rate_position_velocity_ned(double rate_hz) const {
  return _impl->set_rate_position_velocity_ned(rate_hz);
}

void Telemetry::set_rate_ground_truth_async(double rate_hz,
                                            const ResultCallback callback) {
...
void Telemetry::set_rate_fixedwing_metrics_async(
    double rate_hz, const ResultCallback callback) {
...
void Telemetry::set_rate_imu_async(double rate_hz,
                                   const ResultCallback callback) {
...
void Telemetry::set_rate_scaled_imu_async(double rate_hz,
                                          const ResultCallback callback) {
...
void Telemetry::set_rate_raw_imu_async(double rate_hz,
                                       const ResultCallback callback) {
...
void Telemetry::set_rate_unix_epoch_time_async(double rate_hz,
                                               const ResultCallback callback) {
...
void Telemetry::set_rate_distance_sensor_async(double rate_hz,
                                               const ResultCallback callback) {
...
void Telemetry::set_rate_altitude_async(double rate_hz,
                                        const ResultCallback callback) {
...
void Telemetry::set_rate_health_async(double rate_hz,
                                      const ResultCallback callback) {
...
void Telemetry::get_gps_global_origin_async(
    const GetGpsGlobalOriginCallback callback) {
  _impl->get_gps_global_origin_async(callback);
}

std::pair<Telemetry::Result, Telemetry::GpsGlobalOrigin>
Telemetry::get_gps_global_origin() const {
  return _impl->get_gps_global_origin();
}

bool operator==(const Telemetry::Position &lhs,
                const Telemetry::Position &rhs) {
  return ((std::isnan(rhs.latitude_deg) && std::isnan(lhs.latitude_deg)) ||
          rhs.latitude_deg == lhs.latitude_deg) &&
         ((std::isnan(rhs.longitude_deg) && std::isnan(lhs.longitude_deg)) ||
          rhs.longitude_deg == lhs.longitude_deg) &&
         ((std::isnan(rhs.absolute_altitude_m) &&
           std::isnan(lhs.absolute_altitude_m)) ||
          rhs.absolute_altitude_m == lhs.absolute_altitude_m) &&
         ((std::isnan(rhs.relative_altitude_m) &&
           std::isnan(lhs.relative_altitude_m)) ||
...
bool operator==(const Telemetry::Heading &lhs, const Telemetry::Heading &rhs) {
  return ((std::isnan(rhs.heading_deg) && std::isnan(lhs.heading_deg)) ||
...
bool operator==(const Telemetry::Quaternion &lhs,
...
bool operator==(const Telemetry::EulerAngle &lhs,
...
bool operator==(const Telemetry::AngularVelocityBody &lhs,
                const Telemetry::AngularVelocityBody &rhs) {
...
operator<<(std::ostream &str,
           Telemetry::AngularVelocityBody const &angular_velocity_body) {
  str << std::setprecision(15);
...
bool operator==(const Telemetry::RawGps &lhs, const Telemetry::RawGps &rhs) {
  return (rhs.timestamp_us == lhs.timestamp_us) &&
         ...
         ((std::isnan(rhs.cog_deg) && std::isnan(lhs.cog_deg)) ||
          rhs.cog_deg == lhs.cog_deg) &&
         ((std::isnan(rhs.altitude_ellipsoid_m) &&
           std::isnan(lhs.altitude_ellipsoid_m)) ||
         ...
         ((std::isnan(rhs.vertical_uncertainty_m) &&
           std::isnan(lhs.vertical_uncertainty_m)) ||
         ...
         ((std::isnan(rhs.heading_uncertainty_deg) &&
           std::isnan(lhs.heading_uncertainty_deg)) ||
...
bool operator==(const Telemetry::Battery &lhs, const Telemetry::Battery &rhs) {
  return (rhs.id == lhs.id) &&
         ((std::isnan(rhs.temperature_degc) &&
           std::isnan(lhs.temperature_degc)) ||
          rhs.temperature_degc == lhs.temperature_degc) &&
         ((std::isnan(rhs.voltage_v) && std::isnan(lhs.voltage_v)) ||
          rhs.voltage_v == lhs.voltage_v) &&
         ((std::isnan(rhs.current_battery_a) &&
           std::isnan(lhs.current_battery_a)) ||
          rhs.current_battery_a == lhs.current_battery_a) &&
         ((std::isnan(rhs.capacity_consumed_ah) &&
           std::isnan(lhs.capacity_consumed_ah)) ||
          rhs.capacity_consumed_ah == lhs.capacity_consumed_ah) &&
         ((std::isnan(rhs.remaining_percent) &&
           std::isnan(lhs.remaining_percent)) ||
          rhs.remaining_percent == lhs.remaining_percent) &&
         ((std::isnan(rhs.time_remaining_s) &&
           std::isnan(lhs.time_remaining_s)) ||
...
bool operator==(const Telemetry::Health &lhs, const Telemetry::Health &rhs) {
  return (rhs.is_gyrometer_calibration_ok == lhs.is_gyrometer_calibration_ok) &&
         (rhs.is_accelerometer_calibration_ok ==
          lhs.is_accelerometer_calibration_ok) &&
         (rhs.is_magnetometer_calibration_ok ==
          lhs.is_magnetometer_calibration_ok) &&
...
std::ostream &operator<<(std::ostream &str, Telemetry::Health const &health) {
  str << std::setprecision(15);
  str << "health:" << '\n' << "{\n";
  str << "    is_gyrometer_calibration_ok: "
      << health.is_gyrometer_calibration_ok << '\n';
  str << "    is_accelerometer_calibration_ok: "
      << health.is_accelerometer_calibration_ok << '\n';
  str << "    is_magnetometer_calibration_ok: "
...
bool operator==(const Telemetry::RcStatus &lhs,
                const Telemetry::RcStatus &rhs) {
  return (rhs.was_available_once == lhs.was_available_once) &&
         (rhs.is_available == lhs.is_available) &&
         ((std::isnan(rhs.signal_strength_percent) &&
           std::isnan(lhs.signal_strength_percent)) ||
...
bool operator==(const Telemetry::StatusText &lhs,
                const Telemetry::StatusText &rhs) {
  return (rhs.type == lhs.type) && (rhs.text == lhs.text);
}

std::ostream &operator<<(std::ostream &str,
                         Telemetry::StatusText const &status_text) {
  str << std::setprecision(15);
  str << "status_text:" << '\n' << "{\n";
...
bool operator==(const Telemetry::ActuatorControlTarget &lhs,
                const Telemetry::ActuatorControlTarget &rhs) {
  return (rhs.group == lhs.group) && (rhs.controls == lhs.controls);
}

std::ostream &
operator<<(std::ostream &str,
           Telemetry::ActuatorControlTarget const &actuator_control_target) {
  str << std::setprecision(15);
  str << "actuator_control_target:" << '\n' << "{\n";
  str << "    group: " << actuator_control_target.group << '\n';
  str << "    controls: [";
  for (auto it = actuator_control_target.controls.begin();
       it != actuator_control_target.controls.end(); ++it) {
    str << *it;
...
bool operator==(const Telemetry::ActuatorOutputStatus &lhs,
                const Telemetry::ActuatorOutputStatus &rhs) {
  return (rhs.active == lhs.active) && (rhs.actuator == lhs.actuator);
}

std::ostream &
operator<<(std::ostream &str,
           Telemetry::ActuatorOutputStatus const &actuator_output_status) {
  str << std::setprecision(15);
  str << "actuator_output_status:" << '\n' << "{\n";
  str << "    active: " << actuator_output_status.active << '\n';
  str << "    actuator: [";
  for (auto it = actuator_output_status.actuator.begin();
       it != actuator_output_status.actuator.end(); ++it) {
    str << *it;
...
bool operator==(const Telemetry::Covariance &lhs,
                const Telemetry::Covariance &rhs) {
  return (rhs.covariance_matrix == lhs.covariance_matrix);
}

std::ostream &operator<<(std::ostream &str,
                         Telemetry::Covariance const &covariance) {
  str << std::setprecision(15);
  str << "covariance:" << '\n' << "{\n";
  str << "    covariance_matrix: [";
  for (auto it = covariance.covariance_matrix.begin();
       it != covariance.covariance_matrix.end(); ++it) {
    str << *it;
...
bool operator==(const Telemetry::VelocityBody &lhs,
                const Telemetry::VelocityBody &rhs) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::VelocityBody const &velocity_body) {
  str << std::setprecision(15);
  str << "velocity_body:" << '\n' << "{\n";
...
bool operator==(const Telemetry::PositionBody &lhs,
                const Telemetry::PositionBody &rhs) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::PositionBody const &position_body) {
  str << std::setprecision(15);
  str << "position_body:" << '\n' << "{\n";
...
bool operator==(const Telemetry::Odometry &lhs,
                const Telemetry::Odometry &rhs) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::Odometry const &odometry) {
  str << std::setprecision(15);
  str << "odometry:" << '\n' << "{\n";
...
bool operator==(const Telemetry::DistanceSensor &lhs,
                const Telemetry::DistanceSensor &rhs) {
  return ((std::isnan(rhs.minimum_distance_m) &&
           std::isnan(lhs.minimum_distance_m)) ||
          rhs.minimum_distance_m == lhs.minimum_distance_m) &&
         ((std::isnan(rhs.maximum_distance_m) &&
           std::isnan(lhs.maximum_distance_m)) ||
          rhs.maximum_distance_m == lhs.maximum_distance_m) &&
         ((std::isnan(rhs.current_distance_m) &&
           std::isnan(lhs.current_distance_m)) ||
          rhs.current_distance_m == lhs.current_distance_m) &&
         (rhs.orientation == lhs.orientation);
}

std::ostream &operator<<(std::ostream &str,
                         Telemetry::DistanceSensor const &distance_sensor) {
  str << std::setprecision(15);
  str << "distance_sensor:" << '\n' << "{\n";
...
bool operator==(const Telemetry::ScaledPressure &lhs,
                const Telemetry::ScaledPressure &rhs) {
  return (rhs.timestamp_us == lhs.timestamp_us) &&
         ((std::isnan(rhs.absolute_pressure_hpa) &&
           std::isnan(lhs.absolute_pressure_hpa)) ||
         ...
         ((std::isnan(rhs.temperature_deg) &&
           std::isnan(lhs.temperature_deg)) ||
         ...
         ((std::isnan(rhs.differential_pressure_temperature_deg) &&
          ...
          rhs.differential_pressure_temperature_deg ==
              lhs.differential_pressure_temperature_deg);
}

std::ostream &operator<<(std::ostream &str,
                         Telemetry::ScaledPressure const &scaled_pressure) {
  str << std::setprecision(15);
  str << "scaled_pressure:" << '\n' << "{\n";
  str << "    timestamp_us: " << scaled_pressure.timestamp_us << '\n';
  str << "    absolute_pressure_hpa: " << scaled_pressure.absolute_pressure_hpa
      << '\n';
  str << "    differential_pressure_hpa: "
      << scaled_pressure.differential_pressure_hpa << '\n';
...
bool operator==(const Telemetry::VelocityNed &lhs,
                const Telemetry::VelocityNed &rhs) {
...
bool operator==(const Telemetry::GroundTruth &lhs,
                const Telemetry::GroundTruth &rhs) {
  return ((std::isnan(rhs.latitude_deg) && std::isnan(lhs.latitude_deg)) ||
          rhs.latitude_deg == lhs.latitude_deg) &&
         ((std::isnan(rhs.longitude_deg) && std::isnan(lhs.longitude_deg)) ||
          rhs.longitude_deg == lhs.longitude_deg) &&
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::GroundTruth const &ground_truth) {
  str << std::setprecision(15);
  str << "ground_truth:" << '\n' << "{\n";
...
bool operator==(const Telemetry::FixedwingMetrics &lhs,
                const Telemetry::FixedwingMetrics &rhs) {
  return ((std::isnan(rhs.airspeed_m_s) && std::isnan(lhs.airspeed_m_s)) ||
          rhs.airspeed_m_s == lhs.airspeed_m_s) &&
         ((std::isnan(rhs.throttle_percentage) &&
           std::isnan(lhs.throttle_percentage)) ||
         ...
         ((std::isnan(rhs.groundspeed_m_s) &&
           std::isnan(lhs.groundspeed_m_s)) ||
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::FixedwingMetrics const &fixedwing_metrics) {
  str << std::setprecision(15);
...
bool operator==(const Telemetry::AccelerationFrd &lhs,
                const Telemetry::AccelerationFrd &rhs) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::AccelerationFrd const &acceleration_frd) {
  str << std::setprecision(15);
...
bool operator==(const Telemetry::AngularVelocityFrd &lhs,
                const Telemetry::AngularVelocityFrd &rhs) {
...
std::ostream &
operator<<(std::ostream &str,
           Telemetry::AngularVelocityFrd const &angular_velocity_frd) {
  str << std::setprecision(15);
...
bool operator==(const Telemetry::MagneticFieldFrd &lhs,
                const Telemetry::MagneticFieldFrd &rhs) {
...
std::ostream &
operator<<(std::ostream &str,
           Telemetry::MagneticFieldFrd const &magnetic_field_frd) {
  str << std::setprecision(15);
...
bool operator==(const Telemetry::GpsGlobalOrigin &lhs,
                const Telemetry::GpsGlobalOrigin &rhs) {
  return ((std::isnan(rhs.latitude_deg) && std::isnan(lhs.latitude_deg)) ||
          rhs.latitude_deg == lhs.latitude_deg) &&
         ((std::isnan(rhs.longitude_deg) && std::isnan(lhs.longitude_deg)) ||
          rhs.longitude_deg == lhs.longitude_deg) &&
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::GpsGlobalOrigin const &gps_global_origin) {
  str << std::setprecision(15);
...
bool operator==(const Telemetry::Altitude &lhs,
                const Telemetry::Altitude &rhs) {
  return ((std::isnan(rhs.altitude_monotonic_m) &&
           std::isnan(lhs.altitude_monotonic_m)) ||
          rhs.altitude_monotonic_m == lhs.altitude_monotonic_m) &&
         ((std::isnan(rhs.altitude_amsl_m) &&
           std::isnan(lhs.altitude_amsl_m)) ||
          rhs.altitude_amsl_m == lhs.altitude_amsl_m) &&
         ((std::isnan(rhs.altitude_local_m) &&
           std::isnan(lhs.altitude_local_m)) ||
          rhs.altitude_local_m == lhs.altitude_local_m) &&
         ((std::isnan(rhs.altitude_relative_m) &&
           std::isnan(lhs.altitude_relative_m)) ||
          rhs.altitude_relative_m == lhs.altitude_relative_m) &&
         ((std::isnan(rhs.altitude_terrain_m) &&
           std::isnan(lhs.altitude_terrain_m)) ||
          rhs.altitude_terrain_m == lhs.altitude_terrain_m) &&
         ((std::isnan(rhs.bottom_clearance_m) &&
           std::isnan(lhs.bottom_clearance_m)) ||
          rhs.bottom_clearance_m == lhs.bottom_clearance_m);
}

std::ostream &operator<<(std::ostream &str,
                         Telemetry::Altitude const &altitude) {
  str << std::setprecision(15);
  str << "altitude:" << '\n' << "{\n";
...
bool operator==(const Telemetry::Wind &lhs, const Telemetry::Wind &rhs) {
  return ((std::isnan(rhs.wind_x_ned_m_s) && std::isnan(lhs.wind_x_ned_m_s)) ||
         ...
         ((std::isnan(rhs.horizontal_variability_stddev_m_s) &&
          ...
          rhs.horizontal_variability_stddev_m_s ==
              lhs.horizontal_variability_stddev_m_s) &&
         ((std::isnan(rhs.vertical_variability_stddev_m_s) &&
           std::isnan(lhs.vertical_variability_stddev_m_s)) ||
          rhs.vertical_variability_stddev_m_s ==
              lhs.vertical_variability_stddev_m_s) &&
         ((std::isnan(rhs.wind_altitude_msl_m) &&
           std::isnan(lhs.wind_altitude_msl_m)) ||
         ...
         ((std::isnan(rhs.horizontal_wind_speed_accuracy_m_s) &&
          ...
          rhs.horizontal_wind_speed_accuracy_m_s ==
              lhs.horizontal_wind_speed_accuracy_m_s) &&
         ((std::isnan(rhs.vertical_wind_speed_accuracy_m_s) &&
           std::isnan(lhs.vertical_wind_speed_accuracy_m_s)) ||
          rhs.vertical_wind_speed_accuracy_m_s ==
              lhs.vertical_wind_speed_accuracy_m_s);
}
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::FixType const &fix_type) {
  switch (fix_type) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::BatteryFunction const &battery_function) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::FlightMode const &flight_mode) {
  switch (flight_mode) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::StatusTextType const &status_text_type) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::LandedState const &landed_state) {
  switch (landed_state) {
...
std::ostream &operator<<(std::ostream &str,
                         Telemetry::VtolState const &vtol_state) {
  switch (vtol_state) {
