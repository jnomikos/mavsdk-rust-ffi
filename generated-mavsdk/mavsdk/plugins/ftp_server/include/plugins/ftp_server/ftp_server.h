...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/ftp_server/ftp_server.proto)
...
public:
   ...
   * The permissions are the same as the file permission for the user running
   the server.
