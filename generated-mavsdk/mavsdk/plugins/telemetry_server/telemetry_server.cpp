...
TelemetryServer::publish_position(Position position, VelocityNed velocity_ned,
...
TelemetryServer::Result
TelemetryServer::publish_sys_status(Battery battery, bool rc_receiver_status,
                                    bool gyro_status, bool accel_status,
                                    bool mag_status, bool gps_status) const {
  return _impl->publish_sys_status(battery, rc_receiver_status, gyro_status,
                                   accel_status, mag_status, gps_status);
}

TelemetryServer::Result
TelemetryServer::publish_extended_sys_state(VtolState vtol_state,
                                            LandedState landed_state) const {
  return _impl->publish_extended_sys_state(vtol_state, landed_state);
}

TelemetryServer::Result
TelemetryServer::publish_raw_gps(RawGps raw_gps, GpsInfo gps_info) const {
  return _impl->publish_raw_gps(raw_gps, gps_info);
}

TelemetryServer::Result
TelemetryServer::publish_battery(Battery battery) const {
  return _impl->publish_battery(battery);
}

TelemetryServer::Result
TelemetryServer::publish_status_text(StatusText status_text) const {
  return _impl->publish_status_text(status_text);
}

TelemetryServer::Result
TelemetryServer::publish_odometry(Odometry odometry) const {
  return _impl->publish_odometry(odometry);
}

TelemetryServer::Result TelemetryServer::publish_position_velocity_ned(
    PositionVelocityNed position_velocity_ned) const {
  return _impl->publish_position_velocity_ned(position_velocity_ned);
}

TelemetryServer::Result
TelemetryServer::publish_ground_truth(GroundTruth ground_truth) const {
...
TelemetryServer::Result
TelemetryServer::publish_unix_epoch_time(uint64_t time_us) const {
...
bool operator==(const TelemetryServer::Heading &lhs,
...
bool operator==(const TelemetryServer::Quaternion &lhs,
...
std::ostream &operator<<(std::ostream &str,
                         TelemetryServer::Quaternion const &quaternion) {
  str << std::setprecision(15);
  str << "quaternion:" << '\n' << "{\n";
  str << "    w: " << quaternion.w << '\n';
  str << "    x: " << quaternion.x << '\n';
...
bool operator==(const TelemetryServer::EulerAngle &lhs,
...
std::ostream &operator<<(std::ostream &str,
                         TelemetryServer::EulerAngle const &euler_angle) {
  str << std::setprecision(15);
  str << "euler_angle:" << '\n' << "{\n";
...
bool operator==(const TelemetryServer::AngularVelocityBody &lhs,
...
bool operator==(const TelemetryServer::GpsInfo &lhs,
...
bool operator==(const TelemetryServer::RawGps &lhs,
...
bool operator==(const TelemetryServer::Battery &lhs,
...
bool operator==(const TelemetryServer::RcStatus &lhs,
...
bool operator==(const TelemetryServer::StatusText &lhs,
                const TelemetryServer::StatusText &rhs) {
  return (rhs.type == lhs.type) && (rhs.text == lhs.text);
}

std::ostream &operator<<(std::ostream &str,
                         TelemetryServer::StatusText const &status_text) {
  str << std::setprecision(15);
  str << "status_text:" << '\n' << "{\n";
...
bool operator==(const TelemetryServer::ActuatorControlTarget &lhs,
...
bool operator==(const TelemetryServer::ActuatorOutputStatus &lhs,
...
bool operator==(const TelemetryServer::Covariance &lhs,
                const TelemetryServer::Covariance &rhs) {
  return (rhs.covariance_matrix == lhs.covariance_matrix);
}

std::ostream &operator<<(std::ostream &str,
                         TelemetryServer::Covariance const &covariance) {
  str << std::setprecision(15);
  str << "covariance:" << '\n' << "{\n";
...
bool operator==(const TelemetryServer::VelocityBody &lhs,
...
bool operator==(const TelemetryServer::PositionBody &lhs,
...
bool operator==(const TelemetryServer::Odometry &lhs,
...
bool operator==(const TelemetryServer::DistanceSensor &lhs,
...
bool operator==(const TelemetryServer::ScaledPressure &lhs,
...
bool operator==(const TelemetryServer::PositionNed &lhs,
...
bool operator==(const TelemetryServer::VelocityNed &lhs,
...
bool operator==(const TelemetryServer::PositionVelocityNed &lhs,
...
bool operator==(const TelemetryServer::GroundTruth &lhs,
...
bool operator==(const TelemetryServer::FixedwingMetrics &lhs,
...
bool operator==(const TelemetryServer::AccelerationFrd &lhs,
...
bool operator==(const TelemetryServer::AngularVelocityFrd &lhs,
...
bool operator==(const TelemetryServer::MagneticFieldFrd &lhs,
...
bool operator==(const TelemetryServer::Imu &lhs,
