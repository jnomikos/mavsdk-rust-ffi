...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/param/param.proto)
...
Param::Param(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<ParamImpl>(system)} {}
...
std::pair<Param::Result, std::string>
Param::get_param_custom(std::string name) const {
  return _impl->get_param_custom(name);
}

Param::Result Param::set_param_custom(std::string name,
...
Param::Result Param::select_component(int32_t component_id,
...
std::ostream &operator<<(std::ostream &str,
                         Param::ProtocolVersion const &protocol_version) {
