...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/param/param.proto)
...
public:
   ...
   */
  friend bool operator==(const Param::IntParam &lhs,
                         const Param::IntParam &rhs);
  ...
  friend std::ostream &operator<<(std::ostream &str,
                                  Param::IntParam const &int_param);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Param::FloatParam &lhs,
                         const Param::FloatParam &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Param::FloatParam const &float_param);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Param::CustomParam &lhs,
                         const Param::CustomParam &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Param::CustomParam const &custom_param);
   ...
   * @return `true` if items are equal.
   */
  friend bool operator==(const Param::AllParams &lhs,
                         const Param::AllParams &rhs);
   ...
   */
  friend std::ostream &operator<<(std::ostream &str,
                                  Param::AllParams const &all_params);
  ...
  enum class Result {
    ...
    ValueOutOfRange,   /**< @brief Parameter value does not fit within accepted
                          range. */
    PermissionDenied,  /**< @brief Caller is not permitted to set the value of
                          this parameter. */
    ComponentNotFound, /**< @brief Unknown component specified. */
    ReadOnly,          /**< @brief Parameter is read-only. */
    TypeUnsupported, /**< @brief Parameter data type is not supported by flight
                        stack. */
  ...
  /**
   * @brief Select component ID of parameter component to talk to and param
   protocol version.
   *
   ...
   */
  Result select_component(int32_t component_id,
