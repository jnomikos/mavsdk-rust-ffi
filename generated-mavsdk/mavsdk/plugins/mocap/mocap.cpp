...
// (see
// https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/mocap/mocap.proto)
...
Mocap::Mocap(std::shared_ptr<System> system)
    : PluginBase(), _impl{std::make_unique<MocapImpl>(system)} {}

Mocap::~Mocap() {}

Mocap::Result Mocap::set_vision_position_estimate(
    VisionPositionEstimate vision_position_estimate) const {
  return _impl->set_vision_position_estimate(vision_position_estimate);
}

Mocap::Result Mocap::set_vision_speed_estimate(
    VisionSpeedEstimate vision_speed_estimate) const {
  return _impl->set_vision_speed_estimate(vision_speed_estimate);
}

Mocap::Result Mocap::set_attitude_position_mocap(
...
bool operator==(const Mocap::PositionBody &lhs,
...
bool operator==(const Mocap::AngleBody &lhs, const Mocap::AngleBody &rhs) {
  return ((std::isnan(rhs.roll_rad) && std::isnan(lhs.roll_rad)) ||
         ...
         ((std::isnan(rhs.yaw_rad) && std::isnan(lhs.yaw_rad)) ||
          rhs.yaw_rad == lhs.yaw_rad);
}
...
bool operator==(const Mocap::AngularVelocityBody &lhs,
...
bool operator==(const Mocap::VisionPositionEstimate &lhs,
...
bool operator==(const Mocap::VisionSpeedEstimate &lhs,
...
bool operator==(const Mocap::AttitudePositionMocap &lhs,
