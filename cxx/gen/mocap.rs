...
impl<'a> VisionPositionEstimate<'a> {
    ...
    pub fn pose_covariance(&self) -> CovarianceOwned {Covariance::new(self.inner.mocap_get_pose_covariance()).into_owned()
    }
}
...
impl<'a> VisionSpeedEstimate<'a> {
    ...
    pub fn speed_covariance(&self) -> CovarianceOwned {Covariance::new(self.inner.mocap_get_speed_covariance()).into_owned()
    }
}
...
impl<'a> Odometry<'a> {
    ...
    pub fn velocity_covariance(&self) -> CovarianceOwned {Covariance::new(self.inner.mocap_get_velocity_covariance()).into_owned()
    }
}
