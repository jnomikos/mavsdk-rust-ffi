...
impl<'a> ArmDisarm<'a> {
    ...
    impl ActionServerClient {
        ...
        pub fn subscribe_arm_disarm(&self) -> watch::Receiver<std::option::Option<
            ArmDisarmStatus>> {
                ...
                }pub fn subscribe_flight_mode_change(&self) -> watch::Receiver<std::option::Option<
            FlightModeStatus>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.flight_mode_change_handle.is_none() {
                        // Lazy initialization of C++ 'flight_mode_change' action_server stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.flight_mode_change_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_takeoff(&self) -> watch::Receiver<std::option::Option<
            TakeoffStatus>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_land(&self) -> watch::Receiver<std::option::Option<
            LandStatus>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_reboot(&self) -> watch::Receiver<std::option::Option<
            RebootStatus>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_shutdown(&self) -> watch::Receiver<std::option::Option<
            ShutdownStatus>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_terminate(&self) -> watch::Receiver<std::option::Option<
            TerminateStatus>> {
                    let mut inner = self.inner.lock().unwrap();
