...
impl<'a> ProgressDataOrMission<'a> {
    ...
    pub fn mission_plan(&self) -> MissionPlanOwned {
        MissionPlan::new(self.inner.mission_get_mission_plan()).into_owned()
    }
}
