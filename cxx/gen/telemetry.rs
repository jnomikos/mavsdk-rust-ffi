...
impl<'a> GpsInfo<'a> {
    ...
    pub fn fix_type(&self) -> crate::telemetry::mavsdk::Telemetry_FixType {self.inner.telemetry_get_fix_type().clone()
    }
}
...
impl<'a> Battery<'a> {
    ...
    pub fn battery_function(&self) -> crate::telemetry::mavsdk::Telemetry_BatteryFunction {self.inner.telemetry_get_battery_function().clone()
    }
}
...
impl<'a> StatusText<'a> {
    ...
    pub fn r#type(&self) -> crate::telemetry::mavsdk::Telemetry_StatusTextType {self.inner.telemetry_get_type().clone()
    }
        ///  MAVLink status message

    pub fn text(&self) -> String {
        self.inner.telemetry_get_text().to_string_lossy().into_owned()
    }
}
...
impl<'a> Covariance<'a> {
    ...
    pub fn covariance_matrix(&self) -> 
            std::vec::Vec<f32> {
            self.inner.telemetry_get_covariance_matrix().as_slice().to_vec()
    }
}
...
impl<'a> Odometry<'a> {
    ...
    pub fn pose_covariance(&self) -> CovarianceOwned {Covariance::new(self.inner.telemetry_get_pose_covariance()).into_owned()
    }
        ///  Velocity cross-covariance matrix.

    pub fn velocity_covariance(&self) -> CovarianceOwned {Covariance::new(self.inner.telemetry_get_velocity_covariance()).into_owned()
    }
}
...
impl<'a> ScaledPressure<'a> {
    ...
    pub fn differential_pressure_temperature_deg(&self) -> f32 {
        self.inner.telemetry_get_differential_pressure_temperature_deg()
    }
}
...
impl<'a> Wind<'a> {
    ...
    pub fn horizontal_wind_speed_accuracy_m_s(&self) -> f32 {
        self.inner.telemetry_get_horizontal_wind_speed_accuracy_m_s()
    }
    ...
    impl TelemetryClient {
        ...
        pub fn subscribe_position(&self) -> watch::Receiver<std::option::Option<
        PositionOwned>> {
                ...
                }pub fn subscribe_home(&self) -> watch::Receiver<std::option::Option<
        PositionOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_in_air(&self) -> watch::Receiver<std::option::Option<
        bool>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_landed_state(&self) -> watch::Receiver<std::option::Option<
        crate::telemetry::mavsdk::Telemetry_LandedState>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.landed_state_handle.is_none() {
                        // Lazy initialization of C++ 'landed_state' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.landed_state_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_armed(&self) -> watch::Receiver<std::option::Option<
        bool>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_vtol_state(&self) -> watch::Receiver<std::option::Option<
        crate::telemetry::mavsdk::Telemetry_VtolState>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_attitude_quaternion(&self) -> watch::Receiver<std::option::Option<
        QuaternionOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.attitude_quaternion_handle.is_none() {
                        // Lazy initialization of C++ 'attitude_quaternion' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.attitude_quaternion_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_attitude_euler(&self) -> watch::Receiver<std::option::Option<
        EulerAngleOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.attitude_euler_handle.is_none() {
                        // Lazy initialization of C++ 'attitude_euler' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.attitude_euler_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_attitude_angular_velocity_body(&self) -> watch::Receiver<std::option::Option<
        AngularVelocityBodyOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                    ...
                    if inner.attitude_angular_velocity_body_handle.is_none() {
                        ...
                        let user_data_ptr = Box::into_raw(Box::new(self.attitude_angular_velocity_body_tx.clone())) as *mut c_void;

                        let handle = inner.plugin.pin_mut().subscribe_attitude_angular_velocity_body(
                            telemetry_attitude_angular_velocity_body_callback_ffi as usize as libc::uintptr_t,
                            user_data_ptr as libc::uintptr_t
                        ) as usize;
                ...
                }pub fn subscribe_velocity_ned(&self) -> watch::Receiver<std::option::Option<
        VelocityNedOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.velocity_ned_handle.is_none() {
                        // Lazy initialization of C++ 'velocity_ned' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.velocity_ned_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_gps_info(&self) -> watch::Receiver<std::option::Option<
        GpsInfoOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_raw_gps(&self) -> watch::Receiver<std::option::Option<
        RawGpsOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_battery(&self) -> watch::Receiver<std::option::Option<
        BatteryOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_flight_mode(&self) -> watch::Receiver<std::option::Option<
        crate::telemetry::mavsdk::Telemetry_FlightMode>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_health(&self) -> watch::Receiver<std::option::Option<
        HealthOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_rc_status(&self) -> watch::Receiver<std::option::Option<
        RcStatusOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_status_text(&self) -> watch::Receiver<std::option::Option<
        StatusTextOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_actuator_control_target(&self) -> watch::Receiver<std::option::Option<
        ActuatorControlTargetOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.actuator_control_target_handle.is_none() {
                        // Lazy initialization of C++ 'actuator_control_target' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.actuator_control_target_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_actuator_output_status(&self) -> watch::Receiver<std::option::Option<
        ActuatorOutputStatusOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.actuator_output_status_handle.is_none() {
                        // Lazy initialization of C++ 'actuator_output_status' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.actuator_output_status_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_odometry(&self) -> watch::Receiver<std::option::Option<
        OdometryOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_position_velocity_ned(&self) -> watch::Receiver<std::option::Option<
        PositionVelocityNedOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.position_velocity_ned_handle.is_none() {
                        // Lazy initialization of C++ 'position_velocity_ned' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.position_velocity_ned_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_ground_truth(&self) -> watch::Receiver<std::option::Option<
        GroundTruthOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.ground_truth_handle.is_none() {
                        // Lazy initialization of C++ 'ground_truth' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.ground_truth_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_fixedwing_metrics(&self) -> watch::Receiver<std::option::Option<
        FixedwingMetricsOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.fixedwing_metrics_handle.is_none() {
                        // Lazy initialization of C++ 'fixedwing_metrics' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.fixedwing_metrics_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_imu(&self) -> watch::Receiver<std::option::Option<
        ImuOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_scaled_imu(&self) -> watch::Receiver<std::option::Option<
        ImuOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_raw_imu(&self) -> watch::Receiver<std::option::Option<
        ImuOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_health_all_ok(&self) -> watch::Receiver<std::option::Option<
        bool>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.health_all_ok_handle.is_none() {
                        // Lazy initialization of C++ 'health_all_ok' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.health_all_ok_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_unix_epoch_time(&self) -> watch::Receiver<std::option::Option<
        u64>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.unix_epoch_time_handle.is_none() {
                        // Lazy initialization of C++ 'unix_epoch_time' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.unix_epoch_time_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_distance_sensor(&self) -> watch::Receiver<std::option::Option<
        DistanceSensorOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.distance_sensor_handle.is_none() {
                        // Lazy initialization of C++ 'distance_sensor' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.distance_sensor_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_scaled_pressure(&self) -> watch::Receiver<std::option::Option<
        ScaledPressureOwned>> {
                    let mut inner = self.inner.lock().unwrap();

                    if inner.scaled_pressure_handle.is_none() {
                        // Lazy initialization of C++ 'scaled_pressure' telemetry stream.
                        let user_data_ptr = Box::into_raw(Box::new(self.scaled_pressure_tx.clone())) as *mut c_void;
                ...
                }pub fn subscribe_heading(&self) -> watch::Receiver<std::option::Option<
        HeadingOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_altitude(&self) -> watch::Receiver<std::option::Option<
        AltitudeOwned>> {
                    let mut inner = self.inner.lock().unwrap();
                ...
                }pub fn subscribe_wind(&self) -> watch::Receiver<std::option::Option<
        WindOwned>> {
                    let mut inner = self.inner.lock().unwrap();
        ...
        #[unsafe(no_mangle)]
        pub extern "C" fn telemetry_in_air_callback_ffi(
            user_data: *mut c_void,
            in_air: bool,
        ) {
            if user_data.is_null() { return; }
        ...
        #[unsafe(no_mangle)]
        pub extern "C" fn telemetry_armed_callback_ffi(
            user_data: *mut c_void,
            armed: bool,
        ) {
            if user_data.is_null() { return; }
        ...
        pub extern "C" fn telemetry_attitude_angular_velocity_body_callback_ffi(
            ...
            if user_data.is_null() { return; }
                let send_attitude_angular_velocity_body = AngularVelocityBody::new(attitude_angular_velocity_body).into_owned();
        ...
        pub extern "C" fn telemetry_actuator_control_target_callback_ffi(
            ...
            if user_data.is_null() { return; }
                let send_actuator_control_target = ActuatorControlTarget::new(actuator_control_target).into_owned();
        ...
        pub extern "C" fn telemetry_actuator_output_status_callback_ffi(
            ...
            if user_data.is_null() { return; }
                let send_actuator_output_status = ActuatorOutputStatus::new(actuator_output_status).into_owned();
        ...
        pub extern "C" fn telemetry_unix_epoch_time_callback_ffi(
            ...
            if user_data.is_null() { return; }
                let send_unix_epoch_time = 
        unix_epoch_time.clone();
