...
impl Drop for TelemetryClient {
    fn drop(&mut self) {
        if let Ok(mut inner) = self.inner.lock() {
            if let Some(handle) = inner.position_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_position(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.position_user_data
                            as *mut watch::Sender<std::option::Option<PositionOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.home_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_home(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.home_user_data
                            as *mut watch::Sender<std::option::Option<PositionOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.in_air_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_in_air(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.in_air_user_data as *mut watch::Sender<std::option::Option<bool>>,
                    );
                }
            }
            if let Some(handle) = inner.landed_state_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_landed_state(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.landed_state_user_data
                            as *mut watch::Sender<
                                std::option::Option<
            ...
            if let Some(handle) = inner.armed_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_armed(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.armed_user_data as *mut watch::Sender<std::option::Option<bool>>,
                    );
                }
            }
            if let Some(handle) = inner.vtol_state_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_vtol_state(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.vtol_state_user_data
                            as *mut watch::Sender<
            ...
            if let Some(handle) = inner.attitude_quaternion_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_attitude_quaternion(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.attitude_quaternion_user_data
                            as *mut watch::Sender<std::option::Option<QuaternionOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.attitude_euler_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_attitude_euler(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.attitude_euler_user_data
                            as *mut watch::Sender<std::option::Option<EulerAngleOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.attitude_angular_velocity_body_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_attitude_angular_velocity_body(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.attitude_angular_velocity_body_user_data
                            as *mut watch::Sender<std::option::Option<AngularVelocityBodyOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.velocity_ned_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_velocity_ned(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.velocity_ned_user_data
                            as *mut watch::Sender<std::option::Option<VelocityNedOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.gps_info_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_gps_info(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.gps_info_user_data
                            as *mut watch::Sender<std::option::Option<GpsInfoOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.raw_gps_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_raw_gps(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.raw_gps_user_data
                            as *mut watch::Sender<std::option::Option<RawGpsOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.battery_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_battery(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.battery_user_data
                            as *mut watch::Sender<std::option::Option<BatteryOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.flight_mode_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_flight_mode(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.flight_mode_user_data
                            as *mut watch::Sender<
            ...
            if let Some(handle) = inner.health_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_health(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.health_user_data
                            as *mut watch::Sender<std::option::Option<HealthOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.rc_status_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_rc_status(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.rc_status_user_data
                            as *mut watch::Sender<std::option::Option<RcStatusOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.status_text_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_status_text(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.status_text_user_data
                            as *mut watch::Sender<std::option::Option<StatusTextOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.actuator_control_target_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_actuator_control_target(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.actuator_control_target_user_data
                            as *mut watch::Sender<std::option::Option<ActuatorControlTargetOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.actuator_output_status_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_actuator_output_status(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.actuator_output_status_user_data
                            as *mut watch::Sender<std::option::Option<ActuatorOutputStatusOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.odometry_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_odometry(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.odometry_user_data
                            as *mut watch::Sender<std::option::Option<OdometryOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.position_velocity_ned_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_position_velocity_ned(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.position_velocity_ned_user_data
                            as *mut watch::Sender<std::option::Option<PositionVelocityNedOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.ground_truth_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_ground_truth(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.ground_truth_user_data
                            as *mut watch::Sender<std::option::Option<GroundTruthOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.fixedwing_metrics_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_fixedwing_metrics(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.fixedwing_metrics_user_data
                            as *mut watch::Sender<std::option::Option<FixedwingMetricsOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.imu_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_imu(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.imu_user_data as *mut watch::Sender<std::option::Option<ImuOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.scaled_imu_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_scaled_imu(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.scaled_imu_user_data
                            as *mut watch::Sender<std::option::Option<ImuOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.raw_imu_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_raw_imu(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.raw_imu_user_data
                            as *mut watch::Sender<std::option::Option<ImuOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.health_all_ok_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_health_all_ok(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.health_all_ok_user_data
                            as *mut watch::Sender<std::option::Option<bool>>,
                    );
                }
            }
            if let Some(handle) = inner.unix_epoch_time_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_unix_epoch_time(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.unix_epoch_time_user_data
                            as *mut watch::Sender<std::option::Option<u64>>,
                    );
                }
            }
            if let Some(handle) = inner.distance_sensor_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_distance_sensor(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.distance_sensor_user_data
                            as *mut watch::Sender<std::option::Option<DistanceSensorOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.scaled_pressure_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_scaled_pressure(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.scaled_pressure_user_data
                            as *mut watch::Sender<std::option::Option<ScaledPressureOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.heading_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_heading(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.heading_user_data
                            as *mut watch::Sender<std::option::Option<HeadingOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.altitude_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_altitude(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.altitude_user_data
                            as *mut watch::Sender<std::option::Option<AltitudeOwned>>,
                    );
                }
            }
            if let Some(handle) = inner.wind_handle {
                inner
                    .plugin
                    .pin_mut()
                    .unsubscribe_wind(handle as libc::uintptr_t);
                unsafe {
                    let _ = Box::from_raw(
                        inner.wind_user_data as *mut watch::Sender<std::option::Option<WindOwned>>,
                    );
                }
            }
        }
