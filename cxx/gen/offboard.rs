...
pub struct ActuatorControlOwned {
        pub groups: 
            std::vec::Vec<ActuatorControlGroupOwned>,
}
...
impl<'a> ActuatorControl<'a> {
    ...
    pub fn groups(&self) -> 
            std::vec::Vec<ActuatorControlGroupOwned> {
            self.inner.offboard_get_groups()
                .iter()
...
impl<'a> PositionGlobalYaw<'a> {
    ...
    pub fn altitude_type(&self) -> crate::offboard::mavsdk::Offboard_PositionGlobalYaw_AltitudeType {
