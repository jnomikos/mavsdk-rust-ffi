...
namespace AllParams {
  const std::vector<IntParam>& get_int_params(const mavsdk::ParamServer::AllParams& s) { return s.int_params; }
  const std::vector<FloatParam>& get_float_params(const mavsdk::ParamServer::AllParams& s) { return s.float_params; }
  const std::vector<CustomParam>& get_custom_params(const mavsdk::ParamServer::AllParams& s) { return s.custom_params; }
