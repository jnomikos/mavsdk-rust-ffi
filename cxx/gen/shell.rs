...
use std::sync::Mutex;
    ...
    pub struct ShellClient {
        inner: Mutex<ShellInner>,
                ...
                receive_tx: watch::Sender<std::option::Option<
        String>>,
    }
    ...
    impl ShellClient {
        ...
        pub fn subscribe_receive(&self) -> watch::Receiver<std::option::Option<
        String>> {
        ...
        #[unsafe(no_mangle)]
        pub extern "C" fn shell_receive_callback_ffi(
            user_data: *mut c_void,
            receive: cxx::CxxString,
        ) {
