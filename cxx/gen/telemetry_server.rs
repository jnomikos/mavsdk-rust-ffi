...
impl<'a> GpsInfo<'a> {
    ...
    pub fn fix_type(&self) -> crate::telemetry_server::mavsdk::TelemetryServer_FixType {
        self.inner.telemetry_server_get_fix_type().clone()
    }
}
...
impl<'a> StatusText<'a> {
    ...
    pub fn r#type(&self) -> crate::telemetry_server::mavsdk::TelemetryServer_StatusTextType {
        self.inner.telemetry_server_get_type().clone()
    }
    ///  MAVLink status message

    pub fn text(&self) -> String {
        self.inner
            .telemetry_server_get_text()
            .to_string_lossy()
            .into_owned()
    }
}
...
impl<'a> Covariance<'a> {
    ...
    pub fn covariance_matrix(&self) -> std::vec::Vec<f32> {
        self.inner
            .telemetry_server_get_covariance_matrix()
            .as_slice()
            .to_vec()
    }
}
...
impl<'a> Odometry<'a> {
    ...
    pub fn child_frame_id(
        &self,
    ) -> crate::telemetry_server::mavsdk::TelemetryServer_Odometry_MavFrame {
    ...
    pub fn angular_velocity_body(&self) -> AngularVelocityBodyOwned {
        AngularVelocityBody::new(self.inner.telemetry_server_get_angular_velocity_body())
            .into_owned()
    }
    ///  Pose cross-covariance matrix.

    pub fn pose_covariance(&self) -> CovarianceOwned {
        Covariance::new(self.inner.telemetry_server_get_pose_covariance()).into_owned()
    }
    ///  Velocity cross-covariance matrix.

    pub fn velocity_covariance(&self) -> CovarianceOwned {
        Covariance::new(self.inner.telemetry_server_get_velocity_covariance()).into_owned()
    }
}
...
impl<'a> ScaledPressure<'a> {
    ...
    pub fn differential_pressure_temperature_deg(&self) -> f32 {
        self.inner
            .telemetry_server_get_differential_pressure_temperature_deg()
    }
}
...
impl TelemetryServerClient {
    pub fn new(plugin: cxx::UniquePtr<crate::telemetry_server::mavsdk::TelemetryServer>) -> Self {
        Self {
            inner: Mutex::new(TelemetryServerInner { plugin }),
        }
    }
}
